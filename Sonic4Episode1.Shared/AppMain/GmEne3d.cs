...
public partial class AppMain
{
    ...
    public class GMS_ENEMY_3D_WORK : IOBS_OBJECT_WORK
    {
        ...
        public static explicit operator GmGmkPointMarker.GMS_GMK_PMARKER_WORK(AppMain.GMS_ENEMY_3D_WORK p)
        {
            return (GmGmkPointMarker.GMS_GMK_PMARKER_WORK) p.holder;
        }
