...
public partial class AppMain
{
    ...
    {
        AppMain.g_gm_gmk_tarzan_rope_obj_3d_list = AppMain.GmGameDBuildRegBuildModel( AmFs.readAMBFile( AppMain.GmGameDatGetGimmickData( 829 ) ), AmFs.readAMBFile( AppMain.GmGameDatGetGimmickData( 830 ) ), 0U );
    }
    ...
    private static int gmGmkTarzanRopeUpdateAngleCurrent( OBS_OBJECT_WORK obj_work, int angle_target, int angle_current )
    {
    ...
    private static int gmGmkTarzanRopeUpdateAngleTarget( OBS_OBJECT_WORK obj_work, int angle_target, int angle_current, bool flag_motion_change )
    {
        if ( angle_target > 0 )
        {
    ...
    private static int gmGmkTarzanRopeApplyKeyLeft( OBS_OBJECT_WORK obj_work, int angle_target, int angle_current )
    {
    ...
    private static void gmGmkTarzanRopeCheckStop( OBS_OBJECT_WORK obj_work, int angle_target, int angle_current )
    {
        int num = AppMain.MTM_MATH_ABS(angle_target);
        int num2 = AppMain.MTM_MATH_ABS(angle_current);
        if ( num < 208 && num2 < 208 )
    ...
    private static void gmGmkTarzanRopeSetUserWorkTargetAngle( OBS_OBJECT_WORK obj_work, int angle )
    {
    ...
    private static int gmGmkTarzanRopeAddUserWorkTargetAngle( OBS_OBJECT_WORK obj_work, int angle )
    {
        obj_work.user_work += ( uint )angle;
        return ( int )obj_work.user_work;
    }
    ...
    private static void gmGmkTarzanRopeSetUserTimerCurrentAngle( OBS_OBJECT_WORK obj_work, int angle )
    {
    ...
    private static int gmGmkTarzanRopeAddUserTimerCurrentAngle( OBS_OBJECT_WORK obj_work, int angle )
    {
        obj_work.user_timer += angle;
        return obj_work.user_timer;
    }
