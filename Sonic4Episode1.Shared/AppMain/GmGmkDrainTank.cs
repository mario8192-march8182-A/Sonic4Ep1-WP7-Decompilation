...
public partial class AppMain
{
    ...
    private static OBS_OBJECT_WORK GmGmkDrainTankInitIn( AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y, byte type )
    {
    ...
    private static OBS_OBJECT_WORK GmGmkDrainTankInitOut( AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y, byte type )
    {
    ...
    private static OBS_OBJECT_WORK GmGmkDrainTankSplashInit( AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y, byte type )
    {
    ...
    private static AppMain.GMS_ENEMY_3D_WORK gmGmkDrainTankLoadObj( AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y, int type, uint model_id )
    {
        ...
        if ( type == 2 )
        {
            ...
            AppMain.ObjAction3dNNMaterialMotionLoad( gms_ENEMY_3D_WORK.obj_3d, 0, null, null, index, ( AMS_AMB_HEADER )pData );
        }
        return gms_ENEMY_3D_WORK;
    }
    ...
    private static void gmGmkDrainTankSplashInit( OBS_OBJECT_WORK obj_work )
    {
        ...
        OBS_OBJECT_WORK obj_work3 = gms_EFFECT_3DES_WORK2.efct_com.obj_work;
    ...
    private static bool gmGmkDrainTankInCheckDeleteTask( OBS_OBJECT_WORK obj_work, int cmp_x, int cmp_y )
    {
    ...
    private static bool gmGmkDrainTankOutCheckDeleteTask( OBS_OBJECT_WORK obj_work, int cmp_x, int cmp_y )
    {
        GMS_PLAYER_WORK gms_PLAYER_WORK = AppMain.g_gm_main_system.ply_work[(int)((UIntPtr)0)];
        OBS_OBJECT_WORK obj_work2 = gms_PLAYER_WORK.obj_work;
        AppMain.GMS_GMK_DRAIN_TANK_OUT_WORK gms_GMK_DRAIN_TANK_OUT_WORK = (AppMain.GMS_GMK_DRAIN_TANK_OUT_WORK)obj_work;
    ...
    private static bool gmGmkDrainTankOutCheckDirLeft( OBS_OBJECT_WORK gimmick_obj_work, OBS_OBJECT_WORK player_obj_work )
    {
    ...
    private static void gmGmkDrainTankOutAdjustPlayerOffsetWave( AppMain.GMS_GMK_DRAIN_TANK_OUT_WORK out_work, OBS_OBJECT_WORK player_obj_work )
    {
    ...
    private static void gmGmkDrainTankOutApplyPlayerOffset( OBS_OBJECT_WORK player_obj_work, AppMain.GMS_GMK_DRAIN_TANK_OUT_WORK out_work )
    {
    ...
    private static bool gmGmkDrainTankOutCheckKeyDir( OBS_OBJECT_WORK gimmick_obj_work, int camera_roll )
    {
