...
public partial class AppMain
{
    ...
    public static void objDraw3DNNSetCamera(AppMain.OBS_CAMERA obj_camera, int proj_type, uint command_state)
    {
        ...
        else
        {
            ...
            {
                default:
                    nnMakePerspectiveMatrix(nns_MATRIX2, nns_CAMERA_TARGET_ROLL.Fovy, nns_CAMERA_TARGET_ROLL.Aspect, nns_CAMERA_TARGET_ROLL.ZNear, nns_CAMERA_TARGET_ROLL.ZFar);
                    //nnMultiplyMatrix(nns_MATRIX2, nns_MATRIX2, scaleMatrix);
                ...
                case 1:
                    {
                        ...
                        nnMakeOrthoMatrix(nns_MATRIX2, -num3, num3, -num2, num2, nns_CAMERA_TARGET_ROLL.ZNear, nns_CAMERA_TARGET_ROLL.ZFar);
                        //nnMultiplyMatrix(nns_MATRIX2, nns_MATRIX2, scaleMatrix);
                        obs_DRAW_PARAM_3DNN_SET_CAMERA.prj_mtx.Assign(nns_MATRIX2);
                        break;
                    }
