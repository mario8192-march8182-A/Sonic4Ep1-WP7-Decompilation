...
public partial class AppMain
{
    ...
    {
        AppMain.dm_loading_mgr_p.tcb = AppMain.mtTaskMake(AppMain.dmLoadingProcMain, AppMain.dmLoadingDest, 0U, 32767,
            8192U, 10, () => new AppMain.DMS_LOADING_MAIN_WORK(), "LOADING_MAIN");
        AppMain.DMS_LOADING_MAIN_WORK dms_LOADING_MAIN_WORK =
            (AppMain.DMS_LOADING_MAIN_WORK) AppMain.dm_loading_mgr_p.tcb.work;
