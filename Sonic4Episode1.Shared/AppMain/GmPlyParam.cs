...
public partial class AppMain
{
    ...
    {
        // Token: 0x06001EE3 RID: 7907 RVA: 0x0013C84C File Offset: 0x0013AA4C
        public GMS_PLY_PARAMETER(int spd_add, int spd_max, int spd_dec, int spd_spin, int spd_add_spin,
            int spd_max_spin, int spd_dec_spin, int spd_max_add_slope, short time_air, short time_damage,
            short pool_max, ushort fall_wait_time, int spd_slope, int spd_slope_max, int spd_slope_spin,
            int spd_slope_spin_spipe, int spd_slope_spin_pinball, int spd_jump, int spd_fall, int spd_fall_max,
            int push_max, int spd_jump_add, int spd_jump_max, int spd_jump_dec, int spd_add_spin_pinball,
            int spd_max_spin_pinball, int spd_dec_spin_pinball, int spd_max_add_slope_spin_pinball)
        {
