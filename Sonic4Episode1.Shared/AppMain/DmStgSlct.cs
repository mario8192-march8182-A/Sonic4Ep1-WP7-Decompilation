...
public partial class AppMain
{
    ...
    private void dmStgSlctInit()
    {
        ...
        dms_STGSLCT_MAIN_WORK.proc_menu_update = this.dmStgSlctLoadFontData;
    }
    ...
    {
        AppMain.GsFontBuild();
        main_work.proc_menu_update = this.dmStgSlctIsLoadFontData;
    }
    ...
    private void dmStgSlctIsLoadFontData(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        ...
        {
            main_work.proc_menu_update = this.dmStgSlctLoadRequest;
        }
    }
    ...
    private void dmStgSlctProcLoadWait(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        if (this.dmStgSlctIsDataLoad(main_work) != 0)
        {
            ...
            main_work.proc_menu_update = this.dmStgSlctProcLoadWait2;
        }
    }
    ...
    private void dmStgSlctProcLoadWait2(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        if (this.dmStgSlctIsTexLoad(main_work) == 1 && AppMain.DmSndBgmPlayerIsSndSysBuild())
        {
            ...
            main_work.proc_menu_update = this.dmStgSlctProcTexBuildWait;
        }
    }
    ...
    private void dmStgSlctProcTexBuildWait(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        ...
        {
            main_work.proc_menu_update = this.dmStgSlctProcCheckLoadingEnd;
    ...
    private void dmStgSlctProcCheckLoadingEnd(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        ...
        {
            main_work.proc_menu_update = this.dmStgSlctProcCreateAct;
    ...
    private void dmStgSlctProcCreateAct(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        ...
        main_work.proc_menu_update = this.dmStgSlctProcSetDispEfctData;
    }
    ...
    private void dmStgSlctProcSetDispEfctData(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        ...
        {
            main_work.proc_draw = this.dmStgSlctStageSelectDraw;
            main_work.state = 1;
        }
        else
        {
            main_work.proc_draw = this.dmStgSlctZoneSelectDraw;
            main_work.state = 0;
        ...
        main_work.proc_draw = this.dmStgSlctProcActDraw;
        AppMain.IzFadeInitEasy(0U, 0U, 32f);
        main_work.proc_menu_update = this.dmStgSlctProcFadeIn;
    }
    ...
    private void dmStgSlctProcFadeIn(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        ...
        {
            AppMain.IzFadeExit();
            AoPresence.AoPresenceSet(AoPresenceLocation.StageSelect);
            if ((main_work.flag & 131072U) != 0U)
            {
                AppMain.IzFadeInitEasy(0U, 3U, 32f);
                main_work.proc_menu_update = this.dmStgSlctProcSetWhiteFlashEfct;
                return;
            }
            main_work.proc_menu_update = this.dmStgSlctProcSetSlctStartData;
        }
    }
    ...
    private void dmStgSlctProcSetWhiteFlashEfct(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        if (AppMain.IzFadeIsEnd())
        {
            ...
            main_work.proc_menu_update = this.dmStgSlctProcIsWhiteFlashEfctEnd;
        }
    }
    ...
    {
        main_work.proc_win_update = this.dmStgSlctProcWindowNodispIdle;
        if (main_work.state == 0)
        {
            main_work.proc_input = this.dmStgSlctInputProcZoneSelect;
            main_work.proc_menu_update = this.dmStgSlctProcZoneSelectIdle;
        }
        else
        {
            main_work.proc_input = this.dmStgSlctInputProcStageSelect;
            main_work.proc_menu_update = this.dmStgSlctProcStageSelectIdle;
    ...
    private void dmStgSlctProcZoneSelectIdle(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        ...
        if ((main_work.flag & 2U) != 0U)
        {
            ...
            main_work.proc_menu_update = this.dmStgSlctProcFadeOut;
        ...
        if ((main_work.flag & 4U) != 0U)
        {
            ...
            main_work.proc_menu_update = this.dmStgSlctProcZoneSelectDecideEfct;
    ...
    private void dmStgSlctProcZoneSelectDecideEfct(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        ...
        {
            main_work.proc_menu_update = this.dmStgSlctProcZoneSelectOutEfct;
            main_work.flag &= 4294967291U;
    ...
    private void dmStgSlctProcZoneSelectOutEfct(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        ...
        {
            main_work.proc_menu_update = this.dmStgSlctProcStageSelectInEfct;
    ...
    private void dmStgSlctProcStageSelectInEfct(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        ...
        main_work.proc_menu_update = this.dmStgSlctProcStageSelectIdle;
        if (main_work.proc_win_update == this.dmStgSlctProcWindowNodispIdle)
        {
            main_work.proc_input = this.dmStgSlctInputProcStageSelect;
        }
        main_work.disp_flag |= 2U;
    ...
    private void dmStgSlctProcStageSelectIdle(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        ...
        if ((main_work.flag & 2U) != 0U)
        {
            main_work.proc_menu_update = this.dmStgSlctProcStageSelectOutEfct;
            AppMain.DmSoundPlaySE("Cancel");
            main_work.flag &= 4294967293U;
            main_work.proc_input = null;
        ...
        if ((main_work.flag & 4U) != 0U)
        {
            ...
            AppMain.DmSoundPlaySE("Ok");
            main_work.flag &= 4294967291U;
            main_work.proc_win_update = this.dmStgSlctProcWindowOpenEfct;
            main_work.proc_input = null;
            main_work.proc_win_input = null;
        ...
        else
        {
            ...
            {
                main_work.proc_menu_update = this.dmStgSlctProcStageSelectChngZone;
                main_work.proc_input = this.dmStgSlctInputProcStageSelectChngZone;
            ...
            {
                main_work.proc_menu_update = this.dmStgSlctProcStageSelectChngVrtclAct;
                main_work.proc_input = this.dmStgSlctInputProcStageSelectMove;
    ...
    private void dmStgSlctProcStageSelectOutEfct(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        ...
        {
            main_work.proc_menu_update = this.dmStgSlctProcZoneSelectInEfct;
            main_work.state = 0;
            for (int i = 0; i < 6; i++)
            {
                if (main_work.is_final_open == 3)
    ...
    private void dmStgSlctProcWindowOpenEfct(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        ...
        {
            main_work.proc_win_update = this.dmStgSlctProcWindowAnnounceIdle;
            main_work.proc_win_input = this.dmStgSlctInputProcWinDispIdle;
    ...
    private void dmStgSlctProcWindowAnnounceIdle(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        ...
        if (main_work.win_mode == 0)
        {
            ...
            else if ((main_work.flag & 2U) != 0U)
            {
                ...
                main_work.proc_win_update = this.dmStgSlctProcWindowCloseEfct;
                AppMain.DmSoundPlaySE("Cancel");
                main_work.flag &= 4294967291U;
                main_work.flag &= 4294967293U;
            }
    ...
    private void dmStgSlctProcFadeOut(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        ...
        {
            main_work.proc_win_update = null;
            main_work.proc_menu_update = this.dmStgSlctProcStopDraw;
    ...
    {
        main_work.proc_menu_update = this.dmStgSlctProcDataRelease;
    }
    ...
    private void dmStgSlctProcDataRelease(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        ...
        main_work.proc_menu_update = this.dmStgSlctProcFinish;
    }
    ...
    private void dmStgSlctProcFinish(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        if (this.dmStgSlctIsTexRelease(main_work) == 1)
        {
            ...
            main_work.proc_win_update = null;
            main_work.proc_menu_update = this.dmStgSlctProcWaitFinished;
        }
    }
    ...
    private void dmStgSlctCommonFixDraw(AppMain.DMS_STGSLCT_MAIN_WORK main_work)
    {
        ...
        AppMain.AoActAcmPush();
        bool flag = false;
        if (main_work.proc_win_update != null && this.dmStgSlctProcWindowNodispIdle != main_work.proc_win_update)
        {
            flag = true;
        }
    ...
    {
        if (main_work.proc_menu_update != null && 
            main_work.proc_menu_update != this.dmStgSlctProcStageSelectIdle && 
            main_work.proc_menu_update != this.dmStgSlctProcFadeIn &&
            main_work.proc_menu_update != this.dmStgSlctProcSetSlctStartData)
        {
