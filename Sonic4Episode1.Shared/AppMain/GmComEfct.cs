...
public partial class AppMain
{
    ...
    public static void GmComEfctCreateRing( int pos_x, int pos_y )
    {
    ...
    public static void GmComEfctCreateEneDeadSmoke( OBS_OBJECT_WORK obj_work, int ofst_x, int ofst_y )
    {
    ...
    public static void GmComEfctCreateHitPlayer( OBS_OBJECT_WORK obj_work, int ofst_x, int ofst_y )
    {
    }

    // Token: 0x060005CF RID: 1487 RVA: 0x00034024 File Offset: 0x00032224
    public static void GmComEfctCreateHitEnemy( OBS_OBJECT_WORK obj_work, int ofst_x, int ofst_y )
    {
    ...
    public static void GmComEfctCreateSpring( OBS_OBJECT_WORK obj_work, int ofst_x, int ofst_y )
    {
        AppMain.GmComEfctCreateSpring( obj_work, ofst_x, ofst_y, 0 );
    }

    // Token: 0x060005D1 RID: 1489 RVA: 0x00034054 File Offset: 0x00032254
    public static void GmComEfctCreateSpring( OBS_OBJECT_WORK obj_work, int ofst_x, int ofst_y, int ofst_z )
    {
    ...
    public static void GmComEfctSetDispOffset( AppMain.GMS_EFFECT_3DES_WORK efct_work, int ofst_x, int ofst_y, int ofst_z )
    {
    ...
    public static void GmComEfctSetDispOffsetF( AppMain.GMS_EFFECT_3DES_WORK efct_work, float ofst_x, float ofst_y, float ofst_z )
    {
        if ( ( efct_work.efct_com.obj_work.disp_flag & 4194304U ) != 0U )
        {
    ...
    public static void GmComEfctAddDispOffset( AppMain.GMS_EFFECT_3DES_WORK efct_work, int ofst_x, int ofst_y, int ofst_z )
    {
        if ( ( efct_work.efct_com.obj_work.disp_flag & 4194304U ) != 0U )
        {
    ...
    public static void GmComEfctAddDispOffsetF( AppMain.GMS_EFFECT_3DES_WORK efct_work, float ofst_x, float ofst_y, float ofst_z )
    {
        if ( ( efct_work.efct_com.obj_work.disp_flag & 4194304U ) != 0U )
        {
    ...
    public static void GmComEfctSetDispRotation( AppMain.GMS_EFFECT_3DES_WORK efct_work, ushort dir_x, ushort dir_y, ushort dir_z )
    {
        if ( ( efct_work.efct_com.obj_work.disp_flag & 4194304U ) != 0U )
        {
    ...
    public static void GmComEfctSetDispRotationS( AppMain.GMS_EFFECT_3DES_WORK efct_work, short dir_x, short dir_y, short dir_z )
    {
        if ( ( efct_work.efct_com.obj_work.disp_flag & 4194304U ) != 0U )
        {
    ...
    public static void GmComEfctAddDispRotation( AppMain.GMS_EFFECT_3DES_WORK efct_work, ushort dir_x, ushort dir_y, ushort dir_z )
    {
        if ( ( efct_work.efct_com.obj_work.disp_flag & 4194304U ) != 0U )
        {
    ...
    public static void GmComEfctAddDispRotationS( AppMain.GMS_EFFECT_3DES_WORK efct_work, short dir_x, short dir_y, short dir_z )
    {
        if ( ( efct_work.efct_com.obj_work.disp_flag & 4194304U ) != 0U )
        {
