...
public partial class AppMain
{
    ...
    public static void objDiffCollisionDirWidthCheck(OBS_OBJECT_WORK pWork, byte ucWall, int sSpd)
    {
        ...
        if (b4 <= 0)
        {
            ...
            else
            {
                ...
                if ((obs_COL_CHK_DATA.vec & 2) != 0 && (pWork.move_flag & 16384U) == 0U &&
    ...
    public static void objDiffCollisionDirHeightCheck(OBS_OBJECT_WORK pWork)
    {
        ...
        AppMain.objDiffAttrSet(pWork, array[0]);
        if ((pWork.col_flag & 4U) != 0U && (pWork.move_flag & 16U) != 0U && num11 > 0 && (pWork.col_flag & 1U) == 0U &&
            ((array2[0] + pWork.dir_fall >= 16384 && array2[0] + pWork.dir_fall <= 49152) ||
             (array3[0] + pWork.dir_fall >= 16384 && array3[0] + pWork.dir_fall <= 49152)))
        {
            b = 24;
            b2 = 24;
        }
        ...
        if (b3 != 0)
        {
            if (b3 < 0)
            {
                ...
                if (((pWork.move_flag & 1073741824U) == 0U && b3 >= -14 && (pWork.move_flag & 1U) != 0U) ||
                    ((pWork.move_flag & 1073741824U) != 0U && b3 >= -28))
                {
            ...
            if ((pWork.move_flag & 268435456U) == 0U)
            {
                if ((pWork.col_flag & 1U) == 0U && (pWork.move_flag & 64U) != 0U)
                {
                    if (b >= b2)
                    {
                        ...
                        else if (Math.Abs((int) (pWork.dir.z + pWork.dir_fall - array2[0])) >
                                 Math.Abs((int) (pWork.dir.z + pWork.dir_fall - array3[0])))
                        {
                            array2 = array3;
                        }
                    }
                ...
                switch (num3)
                {
                    default:
                        if (pWork.spd.y > 0)
                        {
                            ...
                            {
                                pWork.spd.x = pWork.spd.x +
                                              (pWork.spd.y * AppMain.mtMathSin(
                                                  (int) (pWork.dir.z - AppMain.g_gm_main_system.pseudofall_dir +
                                                         pWork.dir_fall)) >> 12);
                            }
        ...
        if ((pWork.move_flag & 1073741824U) != 0U || num11 < 256)
        {
            ...
            {
                pWork.move_flag |= 2U;
                if (((pWork.move_flag & 1073741824U) == 0U && b6 >= -14) ||
                    ((pWork.move_flag & 1073741824U) != 0U && b6 >= -28))
                {
    ...
    public static int ObjDiffCollision(AppMain.OBS_COL_CHK_DATA pData)
    {
        ...
        if (num == 0)
        {
            ...
            if (num == 0)
            {
                ...
                if (flag)
                {
                    num = AppMain.objGetColDataY(pData.pos_x + num2, pData.pos_y + num3, pData.flag, pData.dir,
                        pData.attr);
                }
                else
                {
                    num = AppMain.objGetColDataX(pData.pos_x + num2, pData.pos_y + num3, pData.flag, pData.dir,
                        pData.attr);
                }
    ...
    public static ushort objGetDirData(int pos_x, int pos_y, ushort suf)
    {
        ...
        AppMain.MP_BLOCK mp_BLOCK =
            AppMain._obj_fcol.block_map_datap[(int) suf][(int) AppMain._obj_fcol.map_block_num_x * num4 + num3];
        int id = (int) mp_BLOCK.id;
    ...
    public static void objGetConv88Pos(int pos_x, int pos_y, ref AppMain.MP_BLOCK mp_block, out int conv_pos_x,
        out int conv_pos_y)
    {
        int num;
        int num2;
    ...
    public static int objGetColDataX(int lPosX, int lPosY, ushort ucSuf, ushort[] pDir, uint[] pAttr)
    {
        ...
        if ((ucSuf & 64) != 0)
        {
            if ((int) ((long) lPosX & -8L) > AppMain._obj_fcol.right - 1 ||
                lPosX < AppMain._obj_fcol.left - 7)
            {
                b = 8;
            }
            else if ((int) (((long) lPosX & -8L) + 8L) >
                     AppMain._obj_fcol.right - 1)
            {
            ...
            else if ((int) ((long) lPosX & -8L) < AppMain._obj_fcol.left)
            {
    ...
    public static int objGetColDataY(int lPosX, int lPosY, ushort ucSuf, ushort[] pDir, uint[] pAttr)
    {
        ...
        if ((ucSuf & 64) != 0)
        {
            if ((int) ((long) lPosY & -8L) > AppMain._obj_fcol.bottom - 1 ||
                lPosY < AppMain._obj_fcol.top - 7)
            {
                return 8;
            }

            if ((int) (((long) lPosY & -8L) + 8L) > AppMain._obj_fcol.bottom - 1)
            {
            ...
            if ((int) ((long) lPosY & -8L) < AppMain._obj_fcol.top)
            {
    ...
    public static void ObjObjectCollisionSet(OBS_OBJECT_WORK pObj, AppMain.OBS_COLLISION_WORK pCol, short sOfstX,
        short sOfstY, ushort usWidth, ushort usHeight)
    {
        if (pCol == null)
        {
    ...
    public static void ObjObjectCollisionDifSet(OBS_OBJECT_WORK pObj, string pPath, AppMain.OBS_DATA_WORK pData,
    ...
    public static void ObjObjectCollisionDirSet(OBS_OBJECT_WORK pObj, string pPath, AppMain.OBS_DATA_WORK pData,
        AMS_AMB_HEADER pArchive)
    {
        if (pObj.col_work != null)
        {
    ...
    public static void ObjObjectCollisionAtrSet(OBS_OBJECT_WORK pObj, string pPath, AppMain.OBS_DATA_WORK pData,
        AMS_AMB_HEADER pArchive)
    {
        if (pObj.col_work != null)
        {
    ...
    public static int ObjCollisionObjectCheck(OBS_OBJECT_WORK pObj, AppMain.OBS_COL_CHK_DATA pData)
    {
        ...
        for (ushort num6 = 0; num6 < (ushort) AppMain._obj_collision_num; num6 += 1)
        {
            ...
            if (obs_COLLISION_OBJ.obj != null && obs_COLLISION_OBJ.obj != pObj && (obs_COLLISION_OBJ.flag & 256U) == 0U)
            {
                ...
                if (obs_COL_CHK_DATA.pos_x >= (obs_COLLISION_OBJ.check_pos.x >> 12) - (int) num5 +
                    (int) obs_COLLISION_OBJ.check_ofst_x &&
                    obs_COL_CHK_DATA.pos_x <= (obs_COLLISION_OBJ.check_pos.x >> 12) + (int) obs_COLLISION_OBJ.width +
                    (int) num5 + (int) obs_COLLISION_OBJ.check_ofst_x &&
                    obs_COL_CHK_DATA.pos_y >= (obs_COLLISION_OBJ.check_pos.y >> 12) - (int) num5 +
                    (int) obs_COLLISION_OBJ.check_ofst_y && obs_COL_CHK_DATA.pos_y <=
                    (obs_COLLISION_OBJ.check_pos.y >> 12) + (int) obs_COLLISION_OBJ.height + (int) num5 +
                    (int) obs_COLLISION_OBJ.check_ofst_y)
                {
                    int num9;
                    if (obs_COLLISION_OBJ.diff_data != null)
                    {
                    ...
                    else
                    {
                        ...
                        {
                            case 0:
                                if (obs_COL_CHK_DATA.pos_x < obs_COLLISION_OBJ.right &&
                                    obs_COL_CHK_DATA.pos_y > obs_COLLISION_OBJ.top &&
                                    obs_COL_CHK_DATA.pos_y < obs_COLLISION_OBJ.bottom)
                                {
                                ...
                                break;
                            case 1:
                                if (obs_COLLISION_OBJ.left < obs_COL_CHK_DATA.pos_x &&
                                    obs_COL_CHK_DATA.pos_y > obs_COLLISION_OBJ.top &&
                                    obs_COL_CHK_DATA.pos_y < obs_COLLISION_OBJ.bottom)
                                {
                                ...
                                break;
                            case 2:
                                if (obs_COL_CHK_DATA.pos_y < obs_COLLISION_OBJ.bottom &&
                                    obs_COL_CHK_DATA.pos_x > obs_COLLISION_OBJ.left &&
                                    obs_COL_CHK_DATA.pos_x < obs_COLLISION_OBJ.right)
                                {
                                ...
                                break;
                            case 3:
                                if (obs_COLLISION_OBJ.top < obs_COL_CHK_DATA.pos_y &&
                                    obs_COL_CHK_DATA.pos_x > obs_COLLISION_OBJ.left &&
                                    obs_COL_CHK_DATA.pos_x < obs_COLLISION_OBJ.right)
                                {
    ...
    public static int objCollisionDiffObject(AppMain.OBS_COLLISION_OBJ pColObj, AppMain.OBS_COL_CHK_DATA pData)
    {
        ...
        if (num5 == 0)
        {
            ...
            if (num5 == 0)
            {
                num += (int) b;
                num2 += (int) b2;
                num5 = pFunc_Delegate(pColObj, pData.pos_x + num, pData.pos_y + num2, pData.flag, pData.dir,
                    pData.attr);
                if (num5 == 0)
                {
                    if (pData.dir != null)
    ...
    public static int objGetColDataX(AppMain.OBS_COLLISION_OBJ pColObj, int lPosX, int lPosY, ushort ucSuf,
        ushort[] pDir, uint[] pAttr)
    {
        sbyte b = 0;
    ...
    public static int objGetColDataY(AppMain.OBS_COLLISION_OBJ pColObj, int lPosX, int lPosY, ushort ucSuf,
        ushort[] pDir, uint[] pAttr)
    {
        sbyte b = 0;
        if (lPosX < pColObj.left || lPosX >= pColObj.right)
