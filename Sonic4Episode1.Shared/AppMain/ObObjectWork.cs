...
public interface IOBS_OBJECT_WORK
{
    // Token: 0x06001D39 RID: 7481
    OBS_OBJECT_WORK Cast();
}
...
public class OBS_OBJECT_WORK : IClearable
{
    ...
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = Create();
    ...
    public static explicit operator AppMain.GMS_GMK_WATER_SLIDER_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_UPBUMPER_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_STEAMP_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_PWALL_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_SEESAWPARTS_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_PRESSWALL_PARTS(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_PWALLCTRL_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_SEESAW_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_SHUTTER_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_P_STEAM_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_PISTONROD_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_PISTON_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_DRAIN_TANK_OUT_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_BOSS3_PILLAR_WALL_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS5_LAND_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS5_CTPLT_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS5_ROCKET_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS5_MGR_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS5_BODY_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS4_BODY_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS4_CAP_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS4_CHIBI_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS4_EGG_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS4_MGR_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_TRUCK_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS2_BALL_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS2_EGG_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS2_BODY_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS2_MGR_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS3_EGG_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS3_BODY_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS3_MGR_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_ENE_UNIDES_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_ENE_UNIUNI_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_ENE_BUKU_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_ENE_T_STAR_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_ENE_KANI_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_ENE_KAMA_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_ENE_MOGU_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator GMS_PLAYER_WORK(OBS_OBJECT_WORK p)
    {
        ...
        return (GMS_PLAYER_WORK) p.holder;
    }

    // Token: 0x06002649 RID: 9801 RVA: 0x0014EE97 File Offset: 0x0014D097
    public static explicit operator AppMain.GMS_GMK_SPCTPLT_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_SLOT_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_CANNONPARTS_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS5_LDPART_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_SLOTPARTS_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS1_EFF_SHOCKWAVE_SUB_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS5_EFCT_GENERAL_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS4_EFF_COMMON_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS1_EFF_SHOCKWAVE_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_POPSTEAMPARTS_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS1_FLASH_SCREEN_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BS_CMN_NODE_CTRL_OBJECT(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_ENE_HARO_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_STOPPER_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS1_CHAIN_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_ENE_GARDON_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_BUMPER_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS1_EGG_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS1_MGR_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS1_BODY_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_BOSS3_PILLAR_MANAGER_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_BLAND_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_BWALL_PARTS(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_BWALL_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_SW_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_EFFECT_3DNN_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_CAM_SCR_LIMIT_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_ENE_STING_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS5_EGG_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_ENEMY_3D_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_DECO_SUBMODEL_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_DECO_WORK(OBS_OBJECT_WORK p)
    {
        return (AppMain.GMS_DECO_WORK) p.holder;
    }

    // Token: 0x0600266A RID: 9834 RVA: 0x0014F071 File Offset: 0x0014D271
    public static explicit operator AppMain.GMS_BOSS5_CORE_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_ENEMY_COM_WORK(OBS_OBJECT_WORK p)
    {
        if (p == null)
        {
            return null;
    ...
    public static explicit operator AppMain.GMS_SCORE_DISP_WORK(OBS_OBJECT_WORK p)
    {
        return (AppMain.GMS_SCORE_DISP_WORK) p.holder;
    }

    // Token: 0x0600266D RID: 9837 RVA: 0x0014F09D File Offset: 0x0014D29D
    public static explicit operator AppMain.GMS_GMK_CANNON_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_BOSS3_PILLAR_MAIN_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS5_TURRET_WORK(OBS_OBJECT_WORK p)
    {
        return (AppMain.GMS_BOSS5_TURRET_WORK) ((AppMain.GMS_ENEMY_3D_WORK) ((AppMain.GMS_ENEMY_COM_WORK) p.holder)
            .holder).holder;
    }

    // Token: 0x06002670 RID: 9840 RVA: 0x0014F0D8 File Offset: 0x0014D2D8
    public static explicit operator AppMain.GMS_ENE_HARI_WORK(OBS_OBJECT_WORK p)
    {
        return (AppMain.GMS_ENE_HARI_WORK) ((AppMain.GMS_ENEMY_3D_WORK) ((AppMain.GMS_ENEMY_COM_WORK) p.holder).holder)
            .holder;
    }

    // Token: 0x06002671 RID: 9841 RVA: 0x0014F0F9 File Offset: 0x0014D2F9
    public static explicit operator AppMain.GMS_GMK_PULLEY_WORK(OBS_OBJECT_WORK p)
    {
        return (AppMain.GMS_GMK_PULLEY_WORK)
            ((AppMain.GMS_ENEMY_3D_WORK) ((AppMain.GMS_ENEMY_COM_WORK) p.holder).holder).holder;
    }

    // Token: 0x06002672 RID: 9842 RVA: 0x0014F11A File Offset: 0x0014D31A
    public static explicit operator AppMain.GMS_ENE_MOTORA_WORK(OBS_OBJECT_WORK p)
    {
        return (AppMain.GMS_ENE_MOTORA_WORK)
            ((AppMain.GMS_ENEMY_3D_WORK) ((AppMain.GMS_ENEMY_COM_WORK) p.holder).holder).holder;
    }

    // Token: 0x06002673 RID: 9843 RVA: 0x0014F13B File Offset: 0x0014D33B
    public static explicit operator AppMain.GMS_GMK_BOBJ_WORK(OBS_OBJECT_WORK p)
    {
        return (AppMain.GMS_GMK_BOBJ_WORK) ((AppMain.GMS_ENEMY_3D_WORK) ((AppMain.GMS_ENEMY_COM_WORK) p.holder).holder)
            .holder;
    }

    // Token: 0x06002674 RID: 9844 RVA: 0x0014F15C File Offset: 0x0014D35C
    public static explicit operator AppMain.GMS_GMK_BOBJ_PARTS(OBS_OBJECT_WORK p)
    {
        return (AppMain.GMS_GMK_BOBJ_PARTS) ((AppMain.GMS_EFFECT_3DNN_WORK) ((AppMain.GMS_EFFECT_COM_WORK) p.holder)
            .holder).holder;
    }

    // Token: 0x06002675 RID: 9845 RVA: 0x0014F17D File Offset: 0x0014D37D
    public static explicit operator AppMain.GMS_EFFECT_3DES_WORK(OBS_OBJECT_WORK work)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_BELTC_WORK(OBS_OBJECT_WORK p)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_ROCK_FALL_WORK(OBS_OBJECT_WORK work)
    {
        return (AppMain.GMS_GMK_ROCK_FALL_WORK) ((AppMain.GMS_ENEMY_3D_WORK) ((AppMain.GMS_ENEMY_COM_WORK) work.holder)
            .holder).holder;
    }

    // Token: 0x0600267F RID: 9855 RVA: 0x0014F218 File Offset: 0x0014D418
    public static explicit operator AppMain.GMS_GMK_ROCK_FALL_MGR_WORK(OBS_OBJECT_WORK work)
    {
        return (AppMain.GMS_GMK_ROCK_FALL_MGR_WORK)
            ((AppMain.GMS_ENEMY_3D_WORK) ((AppMain.GMS_ENEMY_COM_WORK) work.holder).holder).holder;
    }

    // Token: 0x06002680 RID: 9856 RVA: 0x0014F239 File Offset: 0x0014D439
    public static explicit operator AppMain.GMS_BOSS5_ALARM_FADE_WORK(OBS_OBJECT_WORK work)
    {
    ...
    public static explicit operator AppMain.GMS_BOSS5_FLASH_SCREEN_WORK(OBS_OBJECT_WORK work)
    {
    ...
    public static explicit operator AppMain.GMS_GMK_ROCK_CHASE_WORK(OBS_OBJECT_WORK work)
    {
        return (AppMain.GMS_GMK_ROCK_CHASE_WORK) ((AppMain.GMS_ENEMY_3D_WORK) ((AppMain.GMS_ENEMY_COM_WORK) work.holder)
            .holder).holder;
    }

    // Token: 0x06002683 RID: 9859 RVA: 0x0014F27E File Offset: 0x0014D47E
    public static explicit operator AppMain.GMS_GMK_SPEARPARTS_WORK(OBS_OBJECT_WORK work)
    {
        return (AppMain.GMS_GMK_SPEARPARTS_WORK)
            ((AppMain.GMS_EFFECT_3DNN_WORK) ((AppMain.GMS_EFFECT_COM_WORK) work.holder).holder).holder;
    }

    // Token: 0x06002684 RID: 9860 RVA: 0x0014F29F File Offset: 0x0014D49F
    public static explicit operator AppMain.GMS_GMK_SPEAR_WORK(OBS_OBJECT_WORK work)
    {
        return (AppMain.GMS_GMK_SPEAR_WORK) ((AppMain.GMS_ENEMY_3D_WORK) ((AppMain.GMS_ENEMY_COM_WORK) work.holder)
            .holder).holder;
    }

    // Token: 0x06002685 RID: 9861 RVA: 0x0014F2C0 File Offset: 0x0014D4C0
    public static explicit operator AppMain.GMS_GMK_ROCK_WORK(OBS_OBJECT_WORK work)
    {
        return (AppMain.GMS_GMK_ROCK_WORK) ((AppMain.GMS_ENEMY_3D_WORK) ((AppMain.GMS_ENEMY_COM_WORK) work.holder)
            .holder).holder;
    }

    // Token: 0x06002686 RID: 9862 RVA: 0x0014F2E1 File Offset: 0x0014D4E1
    public static explicit operator AppMain.GMS_GMK_SWWALL_WORK(OBS_OBJECT_WORK work)
    {
        return (AppMain.GMS_GMK_SWWALL_WORK) ((AppMain.GMS_ENEMY_3D_WORK) ((AppMain.GMS_ENEMY_COM_WORK) work.holder)
            .holder).holder;
    }
    ...
    {
        get { return Convert.ToUInt32(this.__user_work); }
