...
public partial class AppMain
{
    ...
    public static void GmPlyEfctTrailSysInit()
    {
        ...
        {
            AppMain.gm_ply_efct_trail_sys_tcb = AppMain.MTM_TASK_MAKE_TCB(AppMain.gmPlyEfctTrailSysMain, null, 0U, 0,
                8448U, 3, null, "GM_PLY_EF_TRAIL");
        }
    }
    ...
    public static void GmPlyEfctCreateInvincible(GMS_PLAYER_WORK ply_work)
    {
        ...
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_EFFECT_CREATE_WORK(() => new AppMain.GMS_EFFECT_COM_WORK(),
            ply_work.obj_work, 0, "GM_PLY_INV_MGR");
    ...
    {
        AppMain.GMS_EFFECT_3DES_WORK gms_EFFECT_3DES_WORK;
        if (AppMain.GMM_MAIN_GET_ZONE_TYPE() == 2 && (ply_work.player_flag & 67108864U) != 0U &&
            (ply_work.obj_work.pos.y >> 12) - 4 >= (int) AppMain.g_gm_main_system.water_level)
        {
    ...
    public static object GmPlyEfctCreateSpinDashCircleBlur(GMS_PLAYER_WORK ply_work)
    {
        ...
        AppMain.mtTaskChangeTcbDestructor(gms_EFFECT_3DES_WORK.efct_com.obj_work.tcb,
            AppMain.gmPlyEfctSpinDashBlurDest);
    ...
    public static object GmPlyEfctCreateSpinDashBlur(GMS_PLAYER_WORK ply_work, uint type)
    {
        ...
        gms_EFFECT_3DES_WORK.efct_com.obj_work.ppFunc = AppMain.gmPlyEfctSpinDashBlurMain;
        if ((ply_work.player_flag & 131072U) != 0U || AppMain.GSM_MAIN_STAGE_IS_SPSTAGE_NOT_RETRY())
        {
            AppMain.GmComEfctSetDispOffset(gms_EFFECT_3DES_WORK, 0, 0, 0);
        }
    ...
    {
        AppMain.GMS_EFFECT_3DES_WORK gms_EFFECT_3DES_WORK =
            AppMain.GmEfctCmnEsCreate(ply_work.obj_work, (int) (24U + no));
    ...
    {
        if (ply_work.efct_run_spray != null || AppMain.MTM_MATH_ABS(ply_work.obj_work.spd_m) < 4096 ||
            (ply_work.obj_work.move_flag & 1U) == 0U)
        {
            return;
        }
    ...
    public static void GmPlyEfctCreateHomingCursol(GMS_PLAYER_WORK ply_work)
    {
        ...
        gms_EFFECT_3DES_WORK.efct_com.obj_work.user_timer =
            obs_RECT_WORK.rect.left + obs_RECT_WORK.rect.right >> 1 << 12;
        gms_EFFECT_3DES_WORK.efct_com.obj_work.user_work =
            (uint) ((uint) (obs_RECT_WORK.rect.top + obs_RECT_WORK.rect.bottom >> 1) << 12);
        ...
        AppMain.GmComEfctSetDispOffset(gms_EFFECT_3DES_WORK, gms_EFFECT_3DES_WORK.efct_com.obj_work.user_timer,
            (int) gms_EFFECT_3DES_WORK.efct_com.obj_work.user_work, 524288);
        
        if ((ply_work.player_flag & 128U) == 0U)
            GmSound.PlaySE("Lockon");
    }
    ...
    public static void GmPlyEfctCreateSuperEnd(GMS_PLAYER_WORK ply_work)
    {
        ...
        {
            gms_EFFECT_3DES_WORK.efct_com.obj_work.flag &= 4294966271U;
            gms_EFFECT_3DES_WORK.efct_com.obj_work.pos.x =
                AppMain.FXM_FLOAT_TO_FX32(ply_work.truck_mtx_ply_mtn_pos.M03);
            gms_EFFECT_3DES_WORK.efct_com.obj_work.pos.y =
                AppMain.FXM_FLOAT_TO_FX32(-ply_work.truck_mtx_ply_mtn_pos.M13);
            gms_EFFECT_3DES_WORK.efct_com.obj_work.pos.z =
                AppMain.FXM_FLOAT_TO_FX32(ply_work.truck_mtx_ply_mtn_pos.M23);
        }
    }
    ...
    public static void gmPlyEfctTrailSysMain(MTS_TASK_TCB tcb)
    {
    ...
    public static void gmPlyEfctSpinDashCircleBlurMain(OBS_OBJECT_WORK obj_work)
    {
        ...
        if (gms_PLAYER_WORK.seq_state != 10 && gms_PLAYER_WORK.seq_state != 34 && gms_PLAYER_WORK.seq_state != 44 &&
            gms_PLAYER_WORK.seq_state != 37 && !AppMain.GSM_MAIN_STAGE_IS_SPSTAGE_NOT_RETRY())
        {
            obj_work.flag |= 8U;
            obj_work.ppFunc = AppMain.GmEffectDefaultMainFuncDeleteAtEndCopyDirZ;
        }
        ...
        AppMain.GmEffectDefaultMainFuncDeleteAtEndCopyDirZ(obj_work);
        if ((obj_work.flag & 12U) == 0U && gms_EFFECT_3DES_WORK.efct_com.obj_work.user_timer == 82 &&
            (gms_PLAYER_WORK.player_flag & 16384U) == 0U)
        {
            obj_work.flag |= 8U;
            AppMain.GMS_EFFECT_3DES_WORK gms_EFFECT_3DES_WORK2 =
                (AppMain.GMS_EFFECT_3DES_WORK) AppMain.GmPlyEfctCreateSpinDashCircleBlur(gms_PLAYER_WORK);
    ...
    public static void gmPlyEfctSpinDashBlurMain(OBS_OBJECT_WORK obj_work)
    {
        ...
        obj_work.obj_3des.speed = gms_PLAYER_WORK.obj_work.obj_3d.speed[0];
        if (gms_PLAYER_WORK.seq_state != 10 && gms_PLAYER_WORK.seq_state != 34 && gms_PLAYER_WORK.seq_state != 37 &&
            gms_PLAYER_WORK.seq_state != 44 && gms_PLAYER_WORK.seq_state != 51 && gms_PLAYER_WORK.seq_state != 52 &&
            gms_PLAYER_WORK.seq_state != 53 && gms_PLAYER_WORK.seq_state != 48 && gms_PLAYER_WORK.seq_state != 57 &&
        ...
        if ((obj_work.flag & 12U) == 0U &&
            (gms_EFFECT_3DES_WORK.efct_com.obj_work.user_timer == 83 ||
             gms_EFFECT_3DES_WORK.efct_com.obj_work.user_timer == 81) && (gms_PLAYER_WORK.player_flag & 16384U) == 0U)
        {
            obj_work.flag |= 8U;
            AppMain.GMS_EFFECT_3DES_WORK gms_EFFECT_3DES_WORK2 =
                (AppMain.GMS_EFFECT_3DES_WORK) AppMain.GmPlyEfctCreateSpinDashBlur(gms_PLAYER_WORK,
                    (gms_EFFECT_3DES_WORK.efct_com.obj_work.user_timer == 81) ? 0U : 1U);
            if (gms_EFFECT_3DES_WORK2 != null)
            {
                float speed = AppMain.amEffectGetUnitFrame();
                AppMain.amEffectSetUnitTime(gms_PLAYER_WORK.obj_work.obj_3d.frame[0], 60);
    ...
    public static void gmPlyEfctSpinDashBlurDest(MTS_TASK_TCB tcb)
    {
    ...
    public static void gmPlyEfctWaterCountMain(OBS_OBJECT_WORK obj_work)
    {
        obj_work.user_timer = AppMain.ObjTimeCountDown(obj_work.user_timer);
        GMS_PLAYER_WORK gms_PLAYER_WORK = (GMS_PLAYER_WORK) obj_work.parent_obj;
        if (obj_work.user_timer == 0 || (gms_PLAYER_WORK.player_flag & 1024U) != 0U ||
            (AppMain.GmMainIsWaterLevel() &&
             gms_PLAYER_WORK.obj_work.pos.y >> 12 <= (int) AppMain.g_gm_main_system.water_level) ||
            !AppMain.GmMainIsWaterLevel() || gms_PLAYER_WORK.time_air - gms_PLAYER_WORK.water_timer > 2703360)
        {
            obj_work.flag |= 4U;
            return;
        }
    ...
    public static void gmPlyEfctRunSprayMain(OBS_OBJECT_WORK obj_work)
    {
        ...
        if (parent_obj != null)
        {
            ...
            if ((parent_obj.move_flag & 1U) == 0U ||
                (parent_obj.pos.y >> 12) - 4 >= (int) AppMain.g_gm_main_system.water_level)
            {
                flag2 = true;
            }
    ...
    public static void gmPlyEfctRunSprayDest(MTS_TASK_TCB tcb)
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.mtTaskGetTcbWork(tcb);
        GMS_PLAYER_WORK gms_PLAYER_WORK;
        if (obs_OBJECT_WORK.parent_obj != null && obs_OBJECT_WORK.parent_obj.obj_type == 1)
    ...
    public static void gmPlyEfctHomingCursolMain(OBS_OBJECT_WORK obj_work)
    {
        ...
        if (gms_PLAYER_WORK.enemy_obj != obj_work.parent_obj || !AppMain.GmPlySeqCheckAcceptHoming(gms_PLAYER_WORK))
        {
            ...
            AppMain.GmComEfctSetDispOffset(gms_EFFECT_3DES_WORK, obj_work.user_timer,
                (int) Convert.ToUInt32(obj_work.user_work), 131072);
            obj_work.flag |= 8U;
            obj_work.ppFunc = AppMain.GmEffectDefaultMainFuncDeleteAtEnd;
        }
    ...
    public static void gmPlyEfctSpinStartBlurMain(OBS_OBJECT_WORK obj_work)
    {
        ...
        AppMain.GmEffectDefaultMainFuncDeleteAtEndCopyDirZ(obj_work);
        if ((obj_work.flag & 12U) == 0U && gms_EFFECT_3DES_WORK.efct_com.obj_work.user_work == 84U &&
            (gms_PLAYER_WORK.player_flag & 16384U) == 0U)
        {
            obj_work.flag |= 8U;
            AppMain.GMS_EFFECT_3DES_WORK gms_EFFECT_3DES_WORK2 =
                (AppMain.GMS_EFFECT_3DES_WORK) AppMain.GmPlyEfctCreateSpinStartBlur(gms_PLAYER_WORK);
            if (gms_EFFECT_3DES_WORK2 != null)
            {
                float speed = AppMain.amEffectGetUnitFrame();
                AppMain.amEffectSetUnitTime(gms_PLAYER_WORK.obj_work.obj_3d.frame[0], 60);
    ...
    public static void gmPlyEfctSpinStartBlurDest(MTS_TASK_TCB tcb)
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.mtTaskGetTcbWork(tcb);
        GMS_PLAYER_WORK gms_PLAYER_WORK;
        if (obs_OBJECT_WORK.parent_obj != null && obs_OBJECT_WORK.parent_obj.obj_type == 1)
    ...
    public static void gmPlyEfctSpinJumpBlurMain(OBS_OBJECT_WORK obj_work)
    {
        ...
        if (((gms_PLAYER_WORK.player_flag & 131072U) != 0U && gms_PLAYER_WORK.seq_state != 0 &&
             gms_PLAYER_WORK.seq_state != 1 && gms_PLAYER_WORK.seq_state != 17 && gms_PLAYER_WORK.seq_state != 16 &&
             gms_PLAYER_WORK.seq_state != 21 && gms_PLAYER_WORK.seq_state != 19 && gms_PLAYER_WORK.seq_state != 66 &&
             gms_PLAYER_WORK.seq_state != 45 && gms_PLAYER_WORK.seq_state != 46 && gms_PLAYER_WORK.seq_state != 49 &&
             gms_PLAYER_WORK.seq_state != 50 && gms_PLAYER_WORK.seq_state != 47) ||
            ((gms_PLAYER_WORK.player_flag & 131072U) == 0U &&
             ((gms_PLAYER_WORK.seq_state != 17 && gms_PLAYER_WORK.seq_state != 66 && gms_PLAYER_WORK.seq_state != 45 &&
               gms_PLAYER_WORK.seq_state != 46 && gms_PLAYER_WORK.seq_state != 49 && gms_PLAYER_WORK.seq_state != 50 &&
               gms_PLAYER_WORK.seq_state != 42 && gms_PLAYER_WORK.seq_state != 47) ||
              (gms_PLAYER_WORK.act_state != 39 && gms_PLAYER_WORK.act_state != 26 && gms_PLAYER_WORK.act_state != 67 &&
               gms_PLAYER_WORK.act_state != 27)) && !AppMain.GSM_MAIN_STAGE_IS_SPSTAGE_NOT_RETRY()))
        {
            obj_work.flag |= 8U;
            obj_work.ppFunc = AppMain.GmEffectDefaultMainFuncDeleteAtEndCopyDirZ;
            AppMain.GmEffectDefaultMainFuncDeleteAtEndCopyDirZ(obj_work);
        ...
        if ((obj_work.flag & 12U) == 0U && gms_EFFECT_3DES_WORK.efct_com.obj_work.user_work == 81U &&
            (gms_PLAYER_WORK.player_flag & 16384U) == 0U)
        {
            obj_work.flag |= 8U;
            AppMain.GMS_EFFECT_3DES_WORK gms_EFFECT_3DES_WORK2 =
                (AppMain.GMS_EFFECT_3DES_WORK) AppMain.GmPlyEfctCreateSpinJumpBlur(gms_PLAYER_WORK);
            if (gms_EFFECT_3DES_WORK2 != null)
            {
                float speed = AppMain.amEffectGetUnitFrame();
                AppMain.amEffectSetUnitTime(gms_PLAYER_WORK.obj_work.obj_3d.frame[0], 60);
    ...
    public static void gmPlyEfctSpinJumpBlurDest(MTS_TASK_TCB tcb)
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.mtTaskGetTcbWork(tcb);
        GMS_PLAYER_WORK gms_PLAYER_WORK;
        if (obs_OBJECT_WORK.parent_obj != null && obs_OBJECT_WORK.parent_obj.obj_type == 1)
    ...
    {
        GMS_PLAYER_WORK gms_PLAYER_WORK = (GMS_PLAYER_WORK) obj_work.parent_obj;
        if (gms_PLAYER_WORK == null || (gms_PLAYER_WORK.player_flag & 16384U) == 0U ||
            (gms_PLAYER_WORK.player_flag & 1024U) != 0U || gms_PLAYER_WORK.act_state == 84)
        {
            AppMain.ObjDrawKillAction3DES(obj_work);
            obj_work.ppFunc = AppMain.GmEffectDefaultMainFuncDeleteAtEndCopyDirZ;
            AppMain.GmEffectDefaultMainFuncDeleteAtEndCopyDirZ(obj_work);
    ...
    public static void gmPlyEfctSuperAuraSpinMain(OBS_OBJECT_WORK obj_work)
    {
        ...
        if (gms_PLAYER_WORK == null ||
            ((((gms_PLAYER_WORK.player_flag & 131072U) != 0U && gms_PLAYER_WORK.seq_state != 0 &&
               gms_PLAYER_WORK.seq_state != 1 && gms_PLAYER_WORK.seq_state != 17 && gms_PLAYER_WORK.seq_state != 16 &&
               gms_PLAYER_WORK.seq_state != 21 && gms_PLAYER_WORK.seq_state != 19 && gms_PLAYER_WORK.seq_state != 45 &&
               gms_PLAYER_WORK.seq_state != 46 && gms_PLAYER_WORK.seq_state != 47) ||
              ((gms_PLAYER_WORK.player_flag & 131072U) == 0U &&
               ((gms_PLAYER_WORK.seq_state != 17 && gms_PLAYER_WORK.seq_state != 45 &&
                 gms_PLAYER_WORK.seq_state != 46 && gms_PLAYER_WORK.seq_state != 47) ||
                (gms_PLAYER_WORK.act_state != 39 && gms_PLAYER_WORK.act_state != 26 && gms_PLAYER_WORK.act_state != 27))
              )) && !AppMain.GSM_MAIN_STAGE_IS_SPSTAGE_NOT_RETRY()))
        {
            AppMain.ObjDrawKillAction3DES(obj_work);
            obj_work.ppFunc = AppMain.GmEffectDefaultMainFuncDeleteAtEndCopyDirZ;
