...
public class ObjCamera
{
    ...
    public static void Exit()
    {
        if (obj_camera_tcb != null)
        {
            AppMain.mtTaskClearTcb(obj_camera_tcb);
        }
    }
    ...
    public static void PlaySet(int cam_id, NNS_VECTOR ofst)
    {
    ...
    public static OBS_CAMERA Get(int cam_id)
    {
        if (obj_camera_sys != null)
        {
    ...
    public static void SetUserFunc(int cam_id, OBJF_CAMERA_USER_FUNC user_func)
    {
