...
public partial class AppMain
{
    ...
    public static OBS_OBJECT_WORK GMM_EFFECT_CREATE_WORK(AppMain.TaskWorkFactoryDelegate work_size,
        OBS_OBJECT_WORK parent_obj, ushort sort_prio, string name = "GMM_EFFECT_CREATE_WORK")
    {
        if (work_size == null)
        {
        ...
        OBS_OBJECT_WORK obs_OBJECT_WORK =
            AppMain.OBM_OBJECT_TASK_DETAIL_INIT((ushort) (6656 + sort_prio), 3, 0, 0, work_size, name);
    ...
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK =
            AppMain.GMM_EFFECT_CREATE_WORK(() => new AppMain.GMS_EFFECT_3DES_WORK(), parent_obj, 0, "EF_3DES_DUMMY");
    ...
    private static void GmEffectRectInit(AppMain.GMS_EFFECT_COM_WORK efct_com, ushort[] atk_flag_tbl,
        ushort[] def_flag_tbl, byte my_group, byte target_group_flag)
    {
    ...
    public static void GmEffect3DESSetDispOffsetCircleX(AppMain.GMS_EFFECT_3DES_WORK efct_3des, float radius,
        short angle)
    {
        AppMain.GmEffect3DESSetDispOffset(efct_3des, 0f, radius * AppMain.nnSin((int) angle),
            radius * AppMain.nnCos((int) angle));
    }

    // Token: 0x06001424 RID: 5156 RVA: 0x000B2978 File Offset: 0x000B0B78
    public static void GmEffect3DESSetDispRotation(AppMain.GMS_EFFECT_3DES_WORK efct_3des, short rot_x, short rot_y,
        short rot_z)
    {
        AppMain.OBS_ACTION3D_ES_WORK obj_3des = efct_3des.efct_com.obj_work.obj_3des;
    ...
    private static void GmEffect3DESAddDispRotation(AppMain.GMS_EFFECT_3DES_WORK efct_3des, short rot_add_x,
        short rot_add_y, short rot_add_z)
    {
        AppMain.OBS_ACTION3D_ES_WORK obj_3des = efct_3des.efct_com.obj_work.obj_3des;
