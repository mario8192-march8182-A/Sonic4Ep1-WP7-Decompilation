...
public partial class AppMain
{
    ...
    // Token: 0x06000D2D RID: 3373 RVA: 0x000751B6 File Offset: 0x000733B6
    public static void nnSetProjection(ref Matrix mtx, int type)
    {
        AppMain.nngProjectionMatrix.Assign(ref mtx);
        AppMain.nngProjectionType = type;
        AppMain.nnSetClipPlane();
        AppMain.nnLoadProjectionMatrixGL(ref mtx);
    }
    ...
    // Token: 0x06000D2E RID: 3374 RVA: 0x000751D8 File Offset: 0x000733D8
    public static void nnLoadProjectionMatrixGL(ref Matrix mtx)
    {
        float m = mtx.M31;
        float m2 = mtx.M32;
        float m3 = mtx.M33;
