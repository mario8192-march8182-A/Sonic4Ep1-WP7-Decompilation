...
public partial class AppMain
{
    ...
    {
        AppMain.gm_ene_unides_obj_3d_list = AppMain.GmGameDBuildRegBuildModel( AmFs.readAMBFile( AppMain.GmGameDatGetEnemyData( 690 ) ), AmFs.readAMBFile( AppMain.GmGameDatGetEnemyData( 691 ) ), 0U );
    }

    // Token: 0x06000DEE RID: 3566 RVA: 0x0007AAC0 File Offset: 0x00078CC0
    private static void GmEneUnidesFlush()
    {
        AMS_AMB_HEADER ams_AMB_HEADER = AmFs.readAMBFile(AppMain.GmGameDatGetEnemyData(690));
    ...
    private static OBS_OBJECT_WORK GmEneUnidesNeedleInit( AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y, byte type )
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_ENEMY_CREATE_WORK(eve_rec, pos_x, pos_y, () => new AppMain.GMS_ENE_UNIDES_WORK(), "ENE_UNIDES");
        AppMain.GMS_ENEMY_3D_WORK gms_ENEMY_3D_WORK = (AppMain.GMS_ENEMY_3D_WORK)obs_OBJECT_WORK;
