...
public partial class AppMain
{
    ...
    public static AppMain.AMS_TCB mtTaskGetAmTcb( AppMain.MTS_TASK_TCB tcb )
    {
        return tcb.am_tcb;
    }

    // Token: 0x060016D9 RID: 5849 RVA: 0x000C74C3 File Offset: 0x000C56C3
    public static OBS_OBJECT_WORK mtTaskGetTcbWork( AppMain.MTS_TASK_TCB tcb )
    {
    ...
    public static void mtTaskChangeTcbProcedure( AppMain.MTS_TASK_TCB tcb, AppMain.GSF_TASK_PROCEDURE proc )
    {
        tcb.proc = proc;
    }

    // Token: 0x060016DB RID: 5851 RVA: 0x000C74F7 File Offset: 0x000C56F7
    public static void mtTaskChangeTcbDestructor( AppMain.MTS_TASK_TCB tcb, AppMain.GSF_TASK_PROCEDURE dest )
    {
        tcb.dest = dest;
    }

    // Token: 0x060016DC RID: 5852 RVA: 0x000C7500 File Offset: 0x000C5700
    public static void mtTaskClearTcb( AppMain.MTS_TASK_TCB tcb )
    {
    ...
    public static void mtTaskSystemMain( AppMain.MTS_TASK_TCB tcb )
    {
    ...
    public static void mtTaskSystemDest( AppMain.MTS_TASK_TCB tcb )
    {
