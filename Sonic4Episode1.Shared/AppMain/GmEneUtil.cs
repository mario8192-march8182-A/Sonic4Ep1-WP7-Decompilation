...
public partial class AppMain
{
    ...
    public static NNS_MATRIX GmEneUtilGetNodeMatrix( AppMain.GMS_ENE_NODE_MATRIX node_work, int node_id )
    {
    ...
    public static void GmEneUtilInitNodeMatrix( AppMain.GMS_ENE_NODE_MATRIX node_work, OBS_OBJECT_WORK obj_work, int max_node )
    {
