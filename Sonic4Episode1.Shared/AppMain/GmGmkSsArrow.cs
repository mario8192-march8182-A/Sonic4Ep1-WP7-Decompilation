...
public partial class AppMain
{
    ...
    private static OBS_OBJECT_WORK GmGmkSsArrowInit( AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y, byte type )
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_ENEMY_CREATE_WORK(eve_rec, pos_x, pos_y, () => new AppMain.GMS_ENEMY_3D_WORK(), "GMK_SS_ARROW");
        ...
        AppMain.ObjAction3dNNMaterialMotionLoad( gms_ENEMY_3D_WORK.obj_3d, 0, null, null, 0, AmFs.readAMBFile( AppMain.ObjDataGet( 986 ).pData ) );
    ...
    {
        AppMain.gm_gmk_ss_arrow_obj_3d_list = AppMain.GmGameDBuildRegBuildModel( AmFs.readAMBFile( AppMain.GmGameDatGetGimmickData( 984 ) ), AmFs.readAMBFile( AppMain.GmGameDatGetGimmickData( 985 ) ), 0U );
    }

    // Token: 0x06000DD2 RID: 3538 RVA: 0x0007A15C File Offset: 0x0007835C
    public static void GmGmkSsArrowFlush()
    {
        AMS_AMB_HEADER ams_AMB_HEADER = AmFs.readAMBFile(AppMain.GmGameDatGetGimmickData(984));
