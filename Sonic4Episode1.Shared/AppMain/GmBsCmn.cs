...
public partial class AppMain
{
    ...
    public class GMS_BS_CMN_DELAY_SEARCH_WORK
    {
        ...
        public OBS_OBJECT_WORK targ_obj;
    ...
    public class GMS_BS_CMN_NODE_CTRL_OBJECT : IOBS_OBJECT_WORK
    {
        ...
        public static explicit operator OBS_OBJECT_WORK(AppMain.GMS_BS_CMN_NODE_CTRL_OBJECT work)
        {
    ...
    {
        return (OBS_OBJECT_WORK) AppMain.g_gm_main_system.ply_work[(int) ((UIntPtr) 0)];
    }
    ...
    private static void GmBsCmnSetAction(OBS_OBJECT_WORK obj_work, int act_id, int is_repeat, int is_blend)
    {
        if (is_blend != 0)
        {
    ...
    private static void GmBsCmnSetObjSpd(OBS_OBJECT_WORK obj_work, int spd_x, int spd_y, int spd_z)
    {
    ...
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = (OBS_OBJECT_WORK) efct_com;
        obs_OBJECT_WORK.flag &= 4294967277U;
        obs_OBJECT_WORK.move_flag |= 256U;
        obs_OBJECT_WORK.view_out_ofst = view_out_ofst;
        AppMain.GmEffectRectInit(efct_com, AppMain.gm_bs_cmn_efct_atk_flag_tbl, AppMain.gm_bs_cmn_efct_def_flag_tbl, 1,
            1);
    }

    // Token: 0x06001437 RID: 5175 RVA: 0x000B2D20 File Offset: 0x000B0F20
    private static int GmBsCmnCheckRectMajorOverlapH(AppMain.OBS_RECT_WORK my_rect, AppMain.OBS_RECT_WORK your_rect,
    ...
    private static int GmBsCmnCheckRectMajorOverlapV(AppMain.OBS_RECT_WORK my_rect, AppMain.OBS_RECT_WORK your_rect,
    ...
    private static void GmBsCmnInitBossMotionCBSystem(OBS_OBJECT_WORK obj_work, AppMain.GMS_BS_CMN_BMCB_MGR bmcb_mgr)
    {
        bmcb_mgr.Clear();
    ...
    private static void GmBsCmnClearBossMotionCBSystem(OBS_OBJECT_WORK obj_work)
    {
        ...
        for (AppMain.GMS_BS_CMN_BMCB_LINK gms_BS_CMN_BMCB_LINK = gms_BS_CMN_BMCB_MGR.bmcb_head.next;
            gms_BS_CMN_BMCB_LINK != null;
    ...
    private static void GmBsCmnAppendBossMotionCallback(AppMain.GMS_BS_CMN_BMCB_MGR bmcb_mgr,
    ...
    private static void GmBsCmnCreateSNMWork(AppMain.GMS_BS_CMN_SNM_WORK snm_work, AppMain.NNS_OBJECT _object,
        ushort reg_max)
    {
    ...
    private static NNS_MATRIX GmBsCmnGetSNMMtx(AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id)
    {
        return snm_work.node_info_list[snm_reg_id].node_w_mtx;
    }

    // Token: 0x06001442 RID: 5186 RVA: 0x000B3178 File Offset: 0x000B1378
    private static void GmBsCmnUpdateObjectGeneralStuckWithNode(OBS_OBJECT_WORK obj_work,
        AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, NNS_MATRIX ofst_mtx)
    {
        NNS_MATRIX nns_MATRIX = AppMain.GmBsCmnGetSNMMtx(snm_work, snm_reg_id);
        ...
        if (ofst_mtx != null)
        {
            AppMain.VEC_Set(ref obj_work.pos, obj_work.pos.x + AppMain.FX_F32_TO_FX32(ofst_mtx.M03),
                obj_work.pos.y - AppMain.FX_F32_TO_FX32(ofst_mtx.M13),
                obj_work.pos.z + AppMain.FX_F32_TO_FX32(ofst_mtx.M23));
        }
    }

    // Token: 0x06001443 RID: 5187 RVA: 0x000B3223 File Offset: 0x000B1423
    private static void GmBsCmnUpdateObjectGeneralStuckWithNodeRelative(OBS_OBJECT_WORK obj_work,
        AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, AppMain.VecFx32 pivot_cur_pos,
        AppMain.VecFx32 pivot_prev_pos)
    {
        AppMain.GmBsCmnUpdateObjectGeneralStuckWithNodeRelative(obj_work, snm_work, snm_reg_id, pivot_cur_pos,
            pivot_prev_pos, null);
    }
    ...
    private static void GmBsCmnUpdateObjectGeneralStuckWithNodeRelative(OBS_OBJECT_WORK obj_work,
        AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, AppMain.VecFx32 pivot_cur_pos,
        AppMain.VecFx32 pivot_prev_pos, NNS_MATRIX ofst_mtx)
    {
        AppMain.GmBsCmnUpdateObjectGeneralStuckWithNode(obj_work, snm_work, snm_reg_id, ofst_mtx);
        AppMain.VEC_Set(ref obj_work.pos, obj_work.pos.x - pivot_prev_pos.x + pivot_cur_pos.x,
            obj_work.pos.y - pivot_prev_pos.y + pivot_cur_pos.y, obj_work.pos.z - pivot_prev_pos.z + pivot_cur_pos.z);
    }

    // Token: 0x06001445 RID: 5189 RVA: 0x000B32A7 File Offset: 0x000B14A7
    private static void GmBsCmnUpdateObject3DNNStuckWithNode(OBS_OBJECT_WORK obj_work,
        AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, int b_rotation)
    {
    ...
    private static void GmBsCmnUpdateObject3DNNStuckWithNode(OBS_OBJECT_WORK obj_work,
        AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, int b_rotation, NNS_MATRIX ofst_mtx)
    {
        ...
        if (b_rotation != 0)
        {
            ...
            AkMath.NormalizeMtx(user_obj_mtx_r, nns_MATRIX);
        }
        else
        {
        ...
        if (ofst_mtx != null)
        {
            NNS_MATRIX gmBsCmnUpdateObject3DNNStuckWithNode_rot_mtx =
                AppMain.GmBsCmnUpdateObject3DNNStuckWithNode_rot_mtx;
            NNS_VECTOR nns_VECTOR = new NNS_VECTOR();
            NNS_MATRIX gmBsCmnUpdateObject3DNNStuckWithNode_node_w_rot =
                AppMain.GmBsCmnUpdateObject3DNNStuckWithNode_node_w_rot;
            AppMain.nnCopyMatrix(gmBsCmnUpdateObject3DNNStuckWithNode_node_w_rot, nns_MATRIX);
            gmBsCmnUpdateObject3DNNStuckWithNode_node_w_rot.M03 = (gmBsCmnUpdateObject3DNNStuckWithNode_node_w_rot.M13 =
                (gmBsCmnUpdateObject3DNNStuckWithNode_node_w_rot.M23 = 0f));
            AppMain.nnMultiplyMatrix(gmBsCmnUpdateObject3DNNStuckWithNode_node_w_rot,
                gmBsCmnUpdateObject3DNNStuckWithNode_node_w_rot, ofst_mtx);
            AppMain.nnCopyMatrixTranslationVector(nns_VECTOR, gmBsCmnUpdateObject3DNNStuckWithNode_node_w_rot);
            AppMain.VEC_Set(ref obj_work.pos, obj_work.pos.x + AppMain.FX_F32_TO_FX32(nns_VECTOR.x),
                obj_work.pos.y - AppMain.FX_F32_TO_FX32(nns_VECTOR.y),
                obj_work.pos.z + AppMain.FX_F32_TO_FX32(nns_VECTOR.z));
            AppMain.nnCopyMatrix(gmBsCmnUpdateObject3DNNStuckWithNode_rot_mtx, ofst_mtx);
            gmBsCmnUpdateObject3DNNStuckWithNode_rot_mtx.M03 = (gmBsCmnUpdateObject3DNNStuckWithNode_rot_mtx.M13 =
                (gmBsCmnUpdateObject3DNNStuckWithNode_rot_mtx.M23 = 0f));
            obj_work.disp_flag |= 16777216U;
    ...
    private static void GmBsCmnUpdateObject3DNNStuckWithNodeRelative(OBS_OBJECT_WORK obj_work,
        AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, int b_rotation, AppMain.VecFx32 pivot_cur_pos,
        AppMain.VecFx32 pivot_prev_pos, NNS_MATRIX ofst_mtx)
    {
    ...
    private static void GmBsCmnUpdateObject3DESStuckWithNode(OBS_OBJECT_WORK obj_work,
        AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, int b_rotation)
    {
    ...
    private static void GmBsCmnUpdateObject3DESStuckWithNode(OBS_OBJECT_WORK obj_work,
        AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, int b_rotation, NNS_MATRIX ofst_mtx)
    {
        NNS_MATRIX gmBsCmnUpdateObject3DESStuckWithNode_nml_w_mtx =
            AppMain.GmBsCmnUpdateObject3DESStuckWithNode_nml_w_mtx;
        NNS_QUATERNION user_dir_quat = obj_work.obj_3des.user_dir_quat;
        NNS_MATRIX nns_MATRIX = AppMain.GmBsCmnGetSNMMtx(snm_work, snm_reg_id);
        obj_work.pos.x = AppMain.FX_F32_TO_FX32(nns_MATRIX.M03);
        obj_work.pos.y = -AppMain.FX_F32_TO_FX32(nns_MATRIX.M13);
        obj_work.pos.z = AppMain.FX_F32_TO_FX32(nns_MATRIX.M23);
        if (b_rotation != 0)
        {
            ...
            AkMath.NormalizeMtx(gmBsCmnUpdateObject3DESStuckWithNode_nml_w_mtx, nns_MATRIX);
        ...
        if (ofst_mtx != null)
        {
            NNS_MATRIX gmBsCmnUpdateObject3DESStuckWithNode_rot_mtx =
                AppMain.GmBsCmnUpdateObject3DESStuckWithNode_rot_mtx;
            NNS_QUATERNION nns_QUATERNION = default(NNS_QUATERNION);
            NNS_VECTOR nns_VECTOR = new NNS_VECTOR();
            NNS_MATRIX gmBsCmnUpdateObject3DESStuckWithNode_node_w_rot =
                AppMain.GmBsCmnUpdateObject3DESStuckWithNode_node_w_rot;
            AppMain.nnCopyMatrix(gmBsCmnUpdateObject3DESStuckWithNode_node_w_rot, nns_MATRIX);
            gmBsCmnUpdateObject3DESStuckWithNode_node_w_rot.M03 = (gmBsCmnUpdateObject3DESStuckWithNode_node_w_rot.M13 =
                (gmBsCmnUpdateObject3DESStuckWithNode_node_w_rot.M23 = 0f));
            AppMain.nnMultiplyMatrix(gmBsCmnUpdateObject3DESStuckWithNode_node_w_rot,
                gmBsCmnUpdateObject3DESStuckWithNode_node_w_rot, ofst_mtx);
            AppMain.nnCopyMatrixTranslationVector(nns_VECTOR, gmBsCmnUpdateObject3DESStuckWithNode_node_w_rot);
            AppMain.VEC_Set(ref obj_work.pos, obj_work.pos.x + AppMain.FX_F32_TO_FX32(nns_VECTOR.x),
                obj_work.pos.y - AppMain.FX_F32_TO_FX32(nns_VECTOR.y),
                obj_work.pos.z + AppMain.FX_F32_TO_FX32(nns_VECTOR.z));
            AkMath.NormalizeMtx(gmBsCmnUpdateObject3DESStuckWithNode_rot_mtx, ofst_mtx);
    ...
    private static void GmBsCmnUpdateObject3DESStuckWithNodeRelative(OBS_OBJECT_WORK obj_work,
        AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, int b_rotation, AppMain.VecFx32 pivot_cur_pos,
        AppMain.VecFx32 pivot_prev_pos)
    {
        AppMain.GmBsCmnUpdateObject3DESStuckWithNodeRelative(obj_work, snm_work, snm_reg_id, b_rotation, pivot_cur_pos,
            pivot_prev_pos, null);
    }
    ...
    private static void GmBsCmnInitCNMCb(OBS_OBJECT_WORK obj_work, AppMain.GMS_BS_CMN_CNM_MGR_WORK cnm_mgr_work)
    {
    ...
    private static void GmBsCmnCreateCNMMgrWork(AppMain.GMS_BS_CMN_CNM_MGR_WORK cnm_mgr_work,
        AppMain.NNS_OBJECT _object, ushort reg_max)
    {
        AppMain.UNREFERENCED_PARAMETER(_object);
    ...
    private static void GmBsCmnUpdateCNMParam(OBS_OBJECT_WORK obj_work, AppMain.GMS_BS_CMN_CNM_MGR_WORK cnm_mgr_work)
    {
        ...
        AppMain.GMS_BS_CMN_CNM_NODE_INFO[] array =
            AppMain.amDrawAlloc_GMS_BS_CMN_CNM_NODE_INFO((int) cnm_mgr_work.reg_node_max);
    ...
    private static void GmBsCmnSetCNMMtx(AppMain.GMS_BS_CMN_CNM_MGR_WORK cnm_mgr_work, NNS_MATRIX w_mtx, int cnm_reg_id)
    {
    ...
    private static void GmBsCmnChangeCNMModeNode(AppMain.GMS_BS_CMN_CNM_MGR_WORK cnm_mgr_work, int cnm_reg_id,
        uint mode)
    {
    ...
    private static void GmBsCmnEnableCNMLocalCoordinate(AppMain.GMS_BS_CMN_CNM_MGR_WORK cnm_mgr_work, int cnm_reg_id,
        int enable)
    {
        if (enable != 0)
        {
    ...
    private static void GmBsCmnEnableCNMInheritNodeScale(AppMain.GMS_BS_CMN_CNM_MGR_WORK cnm_mgr_work, int cnm_reg_id,
        int enable)
    {
        if (enable != 0)
        {
    ...
    private static void GmBsCmnEnableCNMMtxNode(AppMain.GMS_BS_CMN_CNM_MGR_WORK cnm_mgr_work, int cnm_reg_id,
        int enable)
    {
        if (enable != 0)
        {
    ...
    private static AppMain.GMS_BS_CMN_NODE_CTRL_OBJECT GmBsCmnCreateNodeControlObjectBySize(OBS_OBJECT_WORK parent_obj,
        AppMain.GMS_BS_CMN_CNM_MGR_WORK cnm_mgr_work, int cnm_reg_id, AppMain.GMS_BS_CMN_SNM_WORK snm_work,
        int snm_reg_id, AppMain.TaskWorkFactoryDelegate work_size)
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK =
            AppMain.GMM_EFFECT_CREATE_WORK(work_size, parent_obj, 0, "bs_cmn_node_ctl_obj");
        AppMain.GMS_BS_CMN_NODE_CTRL_OBJECT gms_BS_CMN_NODE_CTRL_OBJECT =
            (AppMain.GMS_BS_CMN_NODE_CTRL_OBJECT) obs_OBJECT_WORK;
    ...
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = (OBS_OBJECT_WORK) ndc_obj;
        AppMain.nnMakeTranslateMatrix(ndc_obj.w_mtx, AppMain.FX_FX32_TO_F32(obs_OBJECT_WORK.pos.x),
            AppMain.FX_FX32_TO_F32(-obs_OBJECT_WORK.pos.y), AppMain.FX_FX32_TO_F32(obs_OBJECT_WORK.pos.z));
        AppMain.nnQuaternionMatrix(ndc_obj.w_mtx, ndc_obj.w_mtx, ref ndc_obj.user_quat);
        AppMain.nnTranslateMatrix(ndc_obj.w_mtx, ndc_obj.w_mtx, ndc_obj.user_ofst.x, ndc_obj.user_ofst.y,
            ndc_obj.user_ofst.z);
    }

    // Token: 0x0600145B RID: 5211 RVA: 0x000B3AFD File Offset: 0x000B1CFD
    private static void GmBsCmnSetObject3DNNFadedColor(OBS_OBJECT_WORK obj_work, NNS_RGB color, float intensity)
    {
    ...
    private static void GmBsCmnInitObject3DNNDamageFlicker(OBS_OBJECT_WORK obj_work,
        AppMain.GMS_BS_CMN_DMG_FLICKER_WORK flk_work, float radius)
    {
    ...
    private static int GmBsCmnUpdateObject3DNNDamageFlicker(OBS_OBJECT_WORK obj_work,
        AppMain.GMS_BS_CMN_DMG_FLICKER_WORK flk_work)
    {
        ...
        if (flk_work.cycles != 0U)
        {
            ...
            {
                flk_work.cur_angle += AkMath.DEGtoA32(45f);
            ...
            AppMain.GmBsCmnSetObject3DNNFadedColor(obj_work, AppMain.gm_bs_cmn_dmg_flicker_default_color,
                (1f - AppMain.nnCos(flk_work.cur_angle)) / 2f);
            return 0;
        }
    ...
    private static void GmBsCmnEndObject3DNNDamageFlicker(OBS_OBJECT_WORK obj_work,
        AppMain.GMS_BS_CMN_DMG_FLICKER_WORK flk_work)
    {
        flk_work.Clear();
        AppMain.GmBsCmnClearObject3DNNFadedColor(obj_work);
    ...
    private static AppMain.GMS_FADE_OBJ_WORK GmBsCmnInitScreenFadingColor(NNS_RGBA_U8 start_color,
        NNS_RGBA_U8 end_color, float frame)
    {
        AppMain.GMS_FADE_OBJ_WORK gms_FADE_OBJ_WORK =
            AppMain.GmFadeCreateFadeObj(6656, 3, 0, () => new AppMain.GMS_FADE_OBJ_WORK(), 61439, 10U);
        AppMain.GmFadeSetFade(gms_FADE_OBJ_WORK, 0U, start_color.r, start_color.g, start_color.b, start_color.a,
            end_color.r, end_color.g, end_color.b, end_color.a, frame, 0, 0);
    ...
    private static void GmBsCmnInitFlashScreen(AppMain.GMS_CMN_FLASH_SCR_WORK flash_work, float fo_frame,
        float duration_frame, float fi_frame)
    {
        ...
        if (AppMain.GmBsCmnUpdateScreenFadingColor(flash_work.fade_obj_work) != 0)
        {
            if ((flash_work.active_flag & 1U) != 0U)
            {
                ...
                else
                {
                    ...
                    flash_work.fade_obj_work =
                        AppMain.GmBsCmnInitScreenFadingColor(start_color, end_color, flash_work.fi_frame);
                }
            }
    ...
    private static void GmBsCmnInitDelaySearch(AppMain.GMS_BS_CMN_DELAY_SEARCH_WORK dsearch_work,
        OBS_OBJECT_WORK targ_obj, AppMain.VecFx32[] pos_hist_buf, int hist_num)
    {
    ...
    private static void GmBsCmnGetDelaySearchPos(AppMain.GMS_BS_CMN_DELAY_SEARCH_WORK dsearch_work, int delay_time,
    ...
    private static int gmBsCmnCheckActionFrameOverrunOnNextUpdate(OBS_OBJECT_WORK obj_work, ref float overrun_frame)
    {
        AppMain.OBS_ACTION3D_NN_WORK obj_3d = obj_work.obj_3d;
        float num = obj_3d.speed[0] * AppMain.FX_FX32_TO_F32(AppMain.g_obj.speed);
        float num2 = AppMain.amMotionGetEndFrame(obj_3d.motion, obj_3d.act_id[0]) -
                     AppMain.amMotionGetStartFrame(obj_3d.motion, obj_3d.act_id[0]);
    ...
    private static void gmBsCmnInitBossMotionCBLink(AppMain.GMS_BS_CMN_BMCB_LINK bmcb_link,
        AppMain.MPP_VOID_MOTION_NSSOBJECT_OBJECT bmcb_func, object bmcb_param)
    {
        bmcb_link.Clear();
    ...
    private static void gmBsCmnBossMotionCallbackFunc(AppMain.AMS_MOTION motion, AppMain.NNS_OBJECT _object,
        object mtn_cb_param)
    {
    ...
    private static void gmBsCmnMotionCallbackStoreNodeMatrix(AppMain.AMS_MOTION motion, AppMain.NNS_OBJECT _object,
        object mtn_cb_param)
    {
        AppMain.GMS_BS_CMN_SNM_WORK gms_BS_CMN_SNM_WORK = (AppMain.GMS_BS_CMN_SNM_WORK) mtn_cb_param;
        NNS_MATRIX nns_MATRIX = AppMain.gmBsCmnMotionCallbackStoreNodeMatrix_base_mtx;
        ...
        for (int i = 0; i < (int) gms_BS_CMN_SNM_WORK.reg_node_cnt; i++)
        {
            ...
            NNS_MATRIX nns_MATRIX2 = AppMain.gmBsCmnMotionCallbackStoreNodeMatrix_node_mtx;
    ...
    private static void gmBsCmnMtxpltCallbackControlNodeMatrix(NNS_MATRIX[] mtx_plt, AppMain.NNS_OBJECT _object,
        object mplt_cb_param)
    {
        ...
        AppMain.GMS_BS_CMN_CNM_NODE_INFO[] pInfos = ((AppMain.OBS_ACTION3D_NN_WORK.CMPLT_Wrapper) mplt_cb_param)
            .m_pInfos;
        NNS_MATRIX[] array = AppMain.gmBsCmnMtxpltCallbackControlNodeMatrix_orig_mtx_plt;
        if (array == null || array.Length < _object.nMtxPal)
        {
            array = new NNS_MATRIX[_object.nMtxPal];
        ...
        for (int k = 0; k < (int) reg_node_cnt; k++)
        {
            ...
            if (gms_BS_CMN_CNM_NODE_INFO.enable != 0)
            {
                ...
                if (iMatrix != -1)
                {
                    NNS_MATRIX nns_MATRIX = AppMain.gmBsCmnMtxpltCallbackControlNodeMatrix_candidate_mtx;
                    NNS_MATRIX nns_MATRIX2 = AppMain.gmBsCmnMtxpltCallbackControlNodeMatrix_inv_view_mtx;
                    NNS_MATRIX nns_MATRIX3 = AppMain.gmBsCmnMtxpltCallbackControlNodeMatrix_node_w_mtx;
                    ...
                    {
                        NNS_MATRIX nns_MATRIX4 = AppMain.gmBsCmnMtxpltCallbackControlNodeMatrix_cur_mtx;
                        NNS_MATRIX nns_MATRIX5 = AppMain.gmBsCmnMtxpltCallbackControlNodeMatrix_inv_cur_mtx;
                        NNS_MATRIX nns_MATRIX6 = AppMain.gmBsCmnMtxpltCallbackControlNodeMatrix_init_mtx;
                        int iParent = (int) _object.pNodeList[gms_BS_CMN_CNM_NODE_INFO.node_index].iParent;
                        AppMain.nnInvertMatrix(nns_MATRIX6,
                            _object.pNodeList[gms_BS_CMN_CNM_NODE_INFO.node_index].InvInitMtx);
                        if (gms_BS_CMN_CNM_NODE_INFO.mode == 0U)
                        {
                            NNS_MATRIX nns_MATRIX7 = AppMain.gmBsCmnMtxpltCallbackControlNodeMatrix_parent_mtx;
                            NNS_MATRIX nns_MATRIX8 = AppMain.gmBsCmnMtxpltCallbackControlNodeMatrix_diff_mtx;
                            NNS_MATRIX nns_MATRIX9 = AppMain.gmBsCmnMtxpltCallbackControlNodeMatrix_parent_init_mtx;
                            AppMain.nnMultiplyMatrix(nns_MATRIX7, nns_MATRIX2,
                                mtx_plt[(int) _object.pNodeList[iParent].iMatrix]);
                            ...
                            AppMain.nnMultiplyMatrix(nns_MATRIX, nns_MATRIX4,
                                _object.pNodeList[gms_BS_CMN_CNM_NODE_INFO.node_index].InvInitMtx);
                            AppMain.nnMultiplyMatrix(nns_MATRIX3, nns_MATRIX4, gms_BS_CMN_CNM_NODE_INFO.node_w_mtx);
                        }
                        else
                        {
                            NNS_MATRIX nns_MATRIX10 = AppMain.gmBsCmnMtxpltCallbackControlNodeMatrix_parent_cur_mtx;
                            NNS_MATRIX nns_MATRIX11 =
                                AppMain.gmBsCmnMtxpltCallbackControlNodeMatrix_inv_parent_orig_mtx;
                            AppMain.nnCopyMatrix(nns_MATRIX4, nns_MATRIX);
                            AppMain.nnMultiplyMatrix(nns_MATRIX4, nns_MATRIX4, nns_MATRIX6);
                            AppMain.gmBsCmnGetNodeInvWorldMtx(nns_MATRIX11, _object.pNodeList[iParent], nns_MATRIX2,
                                array);
                            AppMain.gmBsCmnGetNodeWorldMtx(nns_MATRIX10, _object.pNodeList[iParent], nns_MATRIX2,
                                mtx_plt);
                    ...
                    {
                        NNS_MATRIX nns_MATRIX12 = AppMain.gmBsCmnMtxpltCallbackControlNodeMatrix_init_mtx;
                        AppMain.nnInvertMatrix(nns_MATRIX12,
                            _object.pNodeList[gms_BS_CMN_CNM_NODE_INFO.node_index].InvInitMtx);
                        AppMain.nnMultiplyMatrix(nns_MATRIX, nns_MATRIX, nns_MATRIX12);
                        AppMain.nnMultiplyMatrix(nns_MATRIX, nns_MATRIX, nns_MATRIX3);
                    }
                    else if ((gms_BS_CMN_CNM_NODE_INFO.flag & AppMain.GMD_BS_CMN_CNM_FLAG_INHERIT_SCALE) != 0U &&
                             (gms_BS_CMN_CNM_NODE_INFO.flag & AppMain.GMD_BS_CMN_CNM_FLAG_LOCAL_COORDINATE) == 0U)
                    {
                        NNS_MATRIX nns_MATRIX13 = AppMain.gmBsCmnMtxpltCallbackControlNodeMatrix_init_mtx;
                        AppMain.nnInvertMatrix(nns_MATRIX13,
                            _object.pNodeList[gms_BS_CMN_CNM_NODE_INFO.node_index].InvInitMtx);
                        AppMain.nnMultiplyMatrix(nns_MATRIX, nns_MATRIX, nns_MATRIX13);
                        AkMath.ExtractScaleMtx(nns_MATRIX, nns_MATRIX);
                        AppMain.nnMultiplyMatrix(nns_MATRIX, nns_MATRIX3, nns_MATRIX);
                    }
                    else
                    {
                    ...
                    if (gms_BS_CMN_CNM_NODE_INFO.mode != 1U)
                    {
                        AppMain.nnMultiplyMatrix(nns_MATRIX, nns_MATRIX,
                            _object.pNodeList[gms_BS_CMN_CNM_NODE_INFO.node_index].InvInitMtx);
                    }
    ...
    {
        AppMain.GMS_BS_CMN_NODE_CTRL_OBJECT
            gms_BS_CMN_NODE_CTRL_OBJECT = (AppMain.GMS_BS_CMN_NODE_CTRL_OBJECT) obj_work;
        ...
        AppMain.GmBsCmnSetCNMMtx(gms_BS_CMN_NODE_CTRL_OBJECT.cnm_mgr_work, gms_BS_CMN_NODE_CTRL_OBJECT.w_mtx,
            gms_BS_CMN_NODE_CTRL_OBJECT.cnm_reg_id);
        AppMain.GmBsCmnEnableCNMMtxNode(gms_BS_CMN_NODE_CTRL_OBJECT.cnm_mgr_work,
            gms_BS_CMN_NODE_CTRL_OBJECT.cnm_reg_id, gms_BS_CMN_NODE_CTRL_OBJECT.is_enable);
    }

    // Token: 0x06001474 RID: 5236 RVA: 0x000B460C File Offset: 0x000B280C
    private static void gmBsCmnGetNodeWorldMtx(NNS_MATRIX dest_mtx, AppMain.NNS_NODE node, NNS_MATRIX inv_view_mtx,
        NNS_MATRIX[] mtx_plt)
    {
        NNS_MATRIX nns_MATRIX = AppMain.gmBsCmnGetNodeWorldMtx_init_mtx;
    ...
    private static void gmBsCmnGetNodeInvWorldMtx(NNS_MATRIX dest_mtx, AppMain.NNS_NODE node, NNS_MATRIX inv_view_mtx,
        NNS_MATRIX[] mtx_plt)
    {
        AppMain.nnMultiplyMatrix(dest_mtx, inv_view_mtx, mtx_plt[(int) node.iMatrix]);
