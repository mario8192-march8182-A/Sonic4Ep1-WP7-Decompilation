...
public partial class AppMain
{
    ...
    private static void GmBsCmnUpdateObjectGeneralStuckWithNode( OBS_OBJECT_WORK obj_work, AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, NNS_MATRIX ofst_mtx )
    {
    ...
    private static void GmBsCmnUpdateObjectGeneralStuckWithNodeRelative( OBS_OBJECT_WORK obj_work, AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, AppMain.VecFx32 pivot_cur_pos, AppMain.VecFx32 pivot_prev_pos )
    {
    ...
    private static void GmBsCmnUpdateObjectGeneralStuckWithNodeRelative( OBS_OBJECT_WORK obj_work, AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, AppMain.VecFx32 pivot_cur_pos, AppMain.VecFx32 pivot_prev_pos, NNS_MATRIX ofst_mtx )
    {
    ...
    private static void GmBsCmnUpdateObject3DNNStuckWithNode( OBS_OBJECT_WORK obj_work, AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, int b_rotation )
    {
    ...
    private static void GmBsCmnUpdateObject3DNNStuckWithNode( OBS_OBJECT_WORK obj_work, AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, int b_rotation, NNS_MATRIX ofst_mtx )
    {
        ...
        if ( ofst_mtx != null )
        {
            NNS_MATRIX gmBsCmnUpdateObject3DNNStuckWithNode_rot_mtx = AppMain.GmBsCmnUpdateObject3DNNStuckWithNode_rot_mtx;
            NNS_VECTOR nns_VECTOR = new NNS_VECTOR();
            NNS_MATRIX gmBsCmnUpdateObject3DNNStuckWithNode_node_w_rot = AppMain.GmBsCmnUpdateObject3DNNStuckWithNode_node_w_rot;
    ...
    private static void GmBsCmnUpdateObject3DNNStuckWithNodeRelative( OBS_OBJECT_WORK obj_work, AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, int b_rotation, AppMain.VecFx32 pivot_cur_pos, AppMain.VecFx32 pivot_prev_pos, NNS_MATRIX ofst_mtx )
    {
    ...
    private static void GmBsCmnUpdateObject3DESStuckWithNode( OBS_OBJECT_WORK obj_work, AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, int b_rotation )
    {
    ...
    private static void GmBsCmnUpdateObject3DESStuckWithNode( OBS_OBJECT_WORK obj_work, AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, int b_rotation, NNS_MATRIX ofst_mtx )
    {
        NNS_MATRIX gmBsCmnUpdateObject3DESStuckWithNode_nml_w_mtx = AppMain.GmBsCmnUpdateObject3DESStuckWithNode_nml_w_mtx;
        ...
        if ( ofst_mtx != null )
        {
            NNS_MATRIX gmBsCmnUpdateObject3DESStuckWithNode_rot_mtx = AppMain.GmBsCmnUpdateObject3DESStuckWithNode_rot_mtx;
            NNS_QUATERNION nns_QUATERNION = default(NNS_QUATERNION);
            NNS_VECTOR nns_VECTOR = new NNS_VECTOR();
            NNS_MATRIX gmBsCmnUpdateObject3DESStuckWithNode_node_w_rot = AppMain.GmBsCmnUpdateObject3DESStuckWithNode_node_w_rot;
    ...
    private static void GmBsCmnUpdateObject3DESStuckWithNodeRelative( OBS_OBJECT_WORK obj_work, AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, int b_rotation, AppMain.VecFx32 pivot_cur_pos, AppMain.VecFx32 pivot_prev_pos )
    {
    ...
    private static void GmBsCmnUpdateObject3DESStuckWithNodeRelative( OBS_OBJECT_WORK obj_work, AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, int b_rotation, AppMain.VecFx32 pivot_cur_pos, AppMain.VecFx32 pivot_prev_pos, NNS_MATRIX ofst_mtx )
    {
    ...
    private static void GmBsCmnSetCNMMtx( AppMain.GMS_BS_CMN_CNM_MGR_WORK cnm_mgr_work, NNS_MATRIX w_mtx, int cnm_reg_id, int enables )
    {
    ...
    private static AppMain.GMS_BS_CMN_NODE_CTRL_OBJECT GmBsCmnCreateNodeControlObjectBySize( OBS_OBJECT_WORK parent_obj, AppMain.GMS_BS_CMN_CNM_MGR_WORK cnm_mgr_work, int cnm_reg_id, AppMain.GMS_BS_CMN_SNM_WORK snm_work, int snm_reg_id, AppMain.TaskWorkFactoryDelegate work_size )
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_EFFECT_CREATE_WORK(work_size, parent_obj, 0, "bs_cmn_node_ctl_obj");
    ...
    private static void GmBsCmnSetObject3DNNFadedColor( OBS_OBJECT_WORK obj_work, NNS_RGB color, float intensity, float radius )
    {
    ...
    private static void GmBsCmnSetObject3DNNFadedColor( OBS_OBJECT_WORK obj_work, NNS_RGB color, float intensity, float radius, float length )
    {
    ...
    private static void GmBsCmnInitObject3DNNDamageFlicker( OBS_OBJECT_WORK obj_work, AppMain.GMS_BS_CMN_DMG_FLICKER_WORK flk_work, float radius )
    {
    ...
    private static int GmBsCmnUpdateObject3DNNDamageFlicker( OBS_OBJECT_WORK obj_work, AppMain.GMS_BS_CMN_DMG_FLICKER_WORK flk_work )
    {
    ...
    private static void GmBsCmnEndObject3DNNDamageFlicker( OBS_OBJECT_WORK obj_work, AppMain.GMS_BS_CMN_DMG_FLICKER_WORK flk_work )
    {
        flk_work.Clear();
        AppMain.GmBsCmnClearObject3DNNFadedColor( obj_work );
    }
    ...
    private static AppMain.GMS_FADE_OBJ_WORK GmBsCmnInitScreenFadingColor( NNS_RGBA_U8 start_color, NNS_RGBA_U8 end_color, float frame )
    {
    ...
    private static void GmBsCmnInitDelaySearch( AppMain.GMS_BS_CMN_DELAY_SEARCH_WORK dsearch_work, OBS_OBJECT_WORK targ_obj, AppMain.VecFx32[] pos_hist_buf, int hist_num )
    {
    ...
    private static void gmBsCmnMtxpltCallbackControlNodeMatrix( NNS_MATRIX[] mtx_plt, AppMain.NNS_OBJECT _object, object mplt_cb_param )
    {
                ...
                if ( iMatrix != -1 )
                {
                    ...
                    if ( ( gms_BS_CMN_CNM_NODE_INFO.flag & AppMain.GMD_BS_CMN_CNM_FLAG_LOCAL_COORDINATE ) != 0U )
                    {
                        ...
                        else
                        {
                            ...
                            NNS_MATRIX nns_MATRIX11 = AppMain.gmBsCmnMtxpltCallbackControlNodeMatrix_inv_parent_orig_mtx;
    ...
    private static void gmBsCmnGetNodeWorldMtx( NNS_MATRIX dest_mtx, AppMain.NNS_NODE node, NNS_MATRIX inv_view_mtx, NNS_MATRIX[] mtx_plt )
    {
    ...
    private static void gmBsCmnGetNodeInvWorldMtx( NNS_MATRIX dest_mtx, AppMain.NNS_NODE node, NNS_MATRIX inv_view_mtx, NNS_MATRIX[] mtx_plt )
    {
        AppMain.nnMultiplyMatrix( dest_mtx, inv_view_mtx, mtx_plt[( int )node.iMatrix] );
