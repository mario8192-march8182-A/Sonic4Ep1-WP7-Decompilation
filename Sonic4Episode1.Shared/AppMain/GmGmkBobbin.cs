...
public partial class AppMain
{
    ...
    private static OBS_OBJECT_WORK GmGmkBobbinInit( AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y, byte type )
    {
    ...
    {
        AppMain.g_gm_gmk_bobbin_obj_3d_list = AppMain.GmGameDBuildRegBuildModel( AmFs.readAMBFile( AppMain.GmGameDatGetGimmickData( 863 ) ), AmFs.readAMBFile( AppMain.GmGameDatGetGimmickData( 864 ) ), 0U );
    }
    ...
    private static void gmGmkBobbinDefEnemy( OBS_OBJECT_WORK obj_work, int speed_x, int speed_y )
    {
