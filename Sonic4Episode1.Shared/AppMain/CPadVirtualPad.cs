...
public partial class AppMain
{
    ...
    public class CPadVirtualPad
    {
        ...
        {
            bool result = false;
            if (pos.x >= this.m_area.left && this.m_area.right >= pos.x && pos.y >= this.m_area.top &&
                this.m_area.bottom >= pos.y)
            {
                result = true;
            }
        ...
        {
            float num = AppMain.CPadVirtualPad.CLocalLogic.Cross(AppMain._SubrtactArray2(p1, target),
                AppMain._SubrtactArray2(p2, target));
            float num2 = AppMain.CPadVirtualPad.CLocalLogic.Cross(AppMain._SubrtactArray2(p2, target),
                AppMain._SubrtactArray2(p3, target));
            float num3 = AppMain.CPadVirtualPad.CLocalLogic.Cross(AppMain._SubrtactArray2(p3, target),
                AppMain._SubrtactArray2(p1, target));
