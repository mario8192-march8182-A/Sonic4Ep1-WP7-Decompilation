...
public partial class AppMain
{
    ...
    public static int gm_map_prim_draw_tvx_mgr_index_tbl_z2_num
    {
        get
        {
            return ((GMS_MAP_PRIM_DRAW_TVX_MGR_INDEX[])AppMain.gm_map_prim_draw_tvx_mgr_index_tbl_z2).Length;
        }
    }
    ...
    public static int gm_map_prim_draw_tvx_mgr_index_tbl_z3_num
    {
        get
        {
            return ((GMS_MAP_PRIM_DRAW_TVX_MGR_INDEX[])AppMain.gm_map_prim_draw_tvx_mgr_index_tbl_z3).Length;
        }
    }
    ...
    public static int gm_map_prim_draw_tvx_mgr_index_tbl_z4_num
    {
        get
        {
            return ((GMS_MAP_PRIM_DRAW_TVX_MGR_INDEX[])AppMain.gm_map_prim_draw_tvx_mgr_index_tbl_z4).Length;
        }
    }
    ...
    public static int gm_map_prim_draw_tvx_mgr_index_tbl_zf_num
    {
        get
        {
            return ((GMS_MAP_PRIM_DRAW_TVX_MGR_INDEX[])AppMain.gm_map_prim_draw_tvx_mgr_index_tbl_zf).Length;
        }
    }
}