...
public partial class AppMain
{
    ...
    private static OBS_OBJECT_WORK GmGmkEnBmprInit( AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y, byte type )
    {
        int num = 3;
    ...
    private static void gmGmkEnBmprInit( OBS_OBJECT_WORK obj_work, int en_bmpr_type, int life_max )
    {
