...
public partial class AppMain
{
    ...
    public class GMS_BOSS2_MGR_WORK : IOBS_OBJECT_WORK
    {
        ...
        public static explicit operator OBS_OBJECT_WORK( AppMain.GMS_BOSS2_MGR_WORK p )
        {
    ...
    public class GMS_BOSS2_BODY_WORK : IOBS_OBJECT_WORK
    {
        ...
        public static explicit operator OBS_OBJECT_WORK( AppMain.GMS_BOSS2_BODY_WORK work )
        {
    ...
    public class GMS_BOSS2_EGG_WORK : IOBS_OBJECT_WORK
    {
        ...
        public static explicit operator OBS_OBJECT_WORK( AppMain.GMS_BOSS2_EGG_WORK p )
        {
            return p.ene_3d.ene_com.obj_work;
        }
    ...
    public class GMS_BOSS2_BALL_WORK : IOBS_OBJECT_WORK
    {
        ...
        public static explicit operator OBS_OBJECT_WORK( AppMain.GMS_BOSS2_BALL_WORK p )
        {
            return p.ene_3d.ene_com.obj_work;
        }
    ...
    public class GMS_BOSS2_EFFECT_SCATTER_WORK : IOBS_OBJECT_WORK
    {
        ...
        public static explicit operator OBS_OBJECT_WORK( AppMain.GMS_BOSS2_EFFECT_SCATTER_WORK p )
        {
        ...
        public NNS_QUATERNION spin_quat = default(NNS_QUATERNION);
    }

    // Token: 0x06001265 RID: 4709 RVA: 0x000A0ED4 File Offset: 0x0009F0D4
    private static void GmBoss2Build()
    {
        AMS_AMB_HEADER ams_AMB_HEADER = AppMain.GmBoss2GetGameDatEnemyArc();
        AMS_AMB_HEADER mdl_amb = (AMS_AMB_HEADER)AppMain.ObjDataLoadAmbIndex(null, 0, ams_AMB_HEADER);
        AMS_AMB_HEADER tex_amb = (AMS_AMB_HEADER)AppMain.ObjDataLoadAmbIndex(null, 1, ams_AMB_HEADER);
    ...
    private static void GmBoss2Flush()
    {
        ...
        AMS_AMB_HEADER amb = AppMain.GmBoss2GetGameDatEnemyArc();
        AMS_AMB_HEADER ams_AMB_HEADER = (AMS_AMB_HEADER)AppMain.ObjDataLoadAmbIndex(null, 0, amb);
    ...
    private static OBS_OBJECT_WORK GmBoss2Init( AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y, byte type )
    {
        ...
        OBS_OBJECT_WORK obj_work = gms_BOSS2_MGR_WORK.ene_3d.ene_com.obj_work;
        obj_work.flag |= 16U;
        obj_work.disp_flag |= 32U;
        obj_work.move_flag |= 8448U;
        gms_BOSS2_MGR_WORK.ene_3d.ene_com.enemy_flag |= 32768U;
        obj_work.ppFunc = AppMain.gmBoss2MgrMainFuncWaitLoad;
    ...
    private static OBS_OBJECT_WORK GmBoss2BodyInit( AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y, byte type )
    {
        ...
        ene_3d.ene_com.rect_work[0].ppDef = AppMain.gmBoss2BodyDefFunc;
        ...
        gms_BOSS2_BODY_WORK.se_handle = GsSound.AllocSeHandle();
        obj_work.ppFunc = AppMain.gmBoss2BodyMainFuncWaitSetup;
        obj_work.ppOut = AppMain.gmBoss2BodyOutFunc;
    ...
    private static OBS_OBJECT_WORK GmBoss2EggInit( AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y, byte type )
    {
        ...
        obj_work.ppFunc = AppMain.gmBoss2EggmanMainFuncWaitSetup;
        obj_work.obj_3d.use_light_flag &= 4294967294U;
        obj_work.obj_3d.use_light_flag |= 64U;
        return obj_work;
    }
    ...
    private static OBS_OBJECT_WORK GmBoss2BallInit( AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y, byte type )
    {
        ...
        ene_3d.ene_com.rect_work[1].ppHit = AppMain.gmBoss2BallHitFunc;
        ...
        obj_work.ppFunc = AppMain.gmBoss2BallMainFuncWaitSetup;
        obj_work.obj_3d.use_light_flag &= 4294967294U;
        obj_work.obj_3d.use_light_flag |= 64U;
        return obj_work;
    }
    ...
    private static AppMain.GMS_BOSS2_MGR_WORK gmBoss2MgrGetMgrWork( OBS_OBJECT_WORK obj_work_parts )
    {
    ...
    private static void gmBoss2MgrAddObject( AppMain.GMS_BOSS2_MGR_WORK mgr_work, OBS_OBJECT_WORK obj_work_parts )
    {
    ...
    private static void gmBoss2MgrMainFuncWaitLoad( OBS_OBJECT_WORK obj_work )
    {
        ...
        OBS_OBJECT_WORK obj_work2 = gms_BOSS2_BODY_WORK.ene_3d.ene_com.obj_work;
        ...
        AppMain.mtTaskChangeTcbDestructor( obj_work2.tcb, AppMain.gmBoss2BodyExit );
        ...
        OBS_OBJECT_WORK obj_work3 = gms_BOSS2_EGG_WORK.ene_3d.ene_com.obj_work;
        obj_work3.parent_obj = obj_work2;
        AppMain.gmBoss2MgrAddObject( gms_BOSS2_MGR_WORK, obj_work3 );
        AppMain.mtTaskChangeTcbDestructor( obj_work3.tcb, AppMain.gmBoss2ExitFunc );
        gms_BOSS2_BODY_WORK.parts_objs[1] = obj_work3;
        obj_work.ppFunc = AppMain.gmBoss2MgrMainFuncWaitSetup;
    }
    ...
    private static void gmBoss2MgrMainFuncWaitSetup( OBS_OBJECT_WORK obj_work )
    {
        ...
        obj_work.ppFunc = AppMain.gmBoss2MgrMainFunc;
    }
    ...
    private static void gmBoss2MgrMainFunc( OBS_OBJECT_WORK obj_work )
    {
        ...
        {
            OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_BS_OBJ(gms_BOSS2_MGR_WORK.body_work);
            obs_OBJECT_WORK.flag |= 8U;
            gms_BOSS2_MGR_WORK.body_work = null;
            obj_work.ppFunc = AppMain.gmBoss2MgrMainFuncWaitRelease;
        }
    }
    ...
    private static void gmBoss2MgrMainFuncWaitRelease( OBS_OBJECT_WORK obj_work )
    {
        ...
        if ( AppMain.GmBsCmnIsFinalZoneType( obj_work ) != 0 )
        {
            ...
            OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.gmBoss2BodySearchShutterOut();
    ...
    private static void gmBoss2BodyExit( AppMain.MTS_TASK_TCB tcb )
    {
        ...
        {
            GsSound.StopSE( gms_BOSS2_BODY_WORK.se_handle );
            GsSound.FreeSeHandle( gms_BOSS2_BODY_WORK.se_handle );
    ...
    private static void gmBoss2BodyReactionPlayer( OBS_OBJECT_WORK obj_work_player, OBS_OBJECT_WORK obj_work_body )
    {
    ...
    {
        AppMain.OBS_RECT_WORK rect_work_arm = body_work.rect_work_arm;
        rect_work_arm.ppHit = AppMain.gmBoss2BodyHitFunc;
        rect_work_arm.ppDef = null;
    ...
    private static void gmBoss2BodyCatchChangeArmRectCatch( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        AppMain.OBS_RECT_WORK rect_work_arm = body_work.rect_work_arm;
        rect_work_arm.ppHit = null;
        rect_work_arm.ppDef = AppMain.gmBoss2BodyCatchHitFuncArmCatch;
        AppMain.ObjRectAtkSet( rect_work_arm, 0, 0 );
    ...
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = (OBS_OBJECT_WORK)body_work;
        AppMain.OBS_RECT_WORK rect_work_arm = body_work.rect_work_arm;
        ...
        obs_OBJECT_WORK.ppRec = AppMain.gmBoss2BodyRecFuncRegistArmRect;
        AppMain.gmBoss2BodyCatchChangeArmRectNormal( body_work );
    }
    ...
    private static void gmBoss2BodySetActionAllParts( AppMain.GMS_BOSS2_BODY_WORK body_work, int action_id, int force_change )
    {
        ...
        while ( 2 > num )
        {
            OBS_OBJECT_WORK obs_OBJECT_WORK = body_work.parts_objs[num];
            if ( obs_OBJECT_WORK != null )
            {
    ...
    private static void gmBoss2BodyDefFunc( AppMain.OBS_RECT_WORK own_rect, AppMain.OBS_RECT_WORK target_rect )
    {
        ...
        OBS_OBJECT_WORK parent_obj2 = own_rect.parent_obj;
    ...
    private static float gmBoss2BodyUpdateMoveNormal( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        else
        {
            ...
            int ang = AkMath.DEGtoA32(180f * num);
    ...
    private static void gmBoss2BodyInitTurn( AppMain.GMS_BOSS2_BODY_WORK body_work, short dest_angle, float frame, int flag_positive )
    {
        ...
        if ( flag_positive == 0 )
        {
            ushort num = (ushort)(body_work.turn_amount - AkMath.DEGtoA32(360));
            body_work.turn_amount = ( int )num - AkMath.DEGtoA32( 360 );
        }
    }
    ...
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_BS_OBJ(body_work);
        OBS_OBJECT_WORK obs_OBJECT_WORK2 = AppMain.GmBsCmnGetPlayerObj();
    ...
    {
        OBS_OBJECT_WORK p = AppMain.GmBsCmnGetPlayerObj();
        GMS_PLAYER_WORK gms_PLAYER_WORK = (GMS_PLAYER_WORK)p;
        int num = 0;
        int num2 = 0;
        while ( 16 > num2 )
        {
    ...
    {
        NNS_MATRIX nns_MATRIX = AppMain.GmBsCmnGetSNMMtx(body_work.snm_work, body_work.snm_reg_id[2]);
        NNS_MATRIX dst_mtx = new NNS_MATRIX();
        AkMath.ExtractScaleMtx( dst_mtx, nns_MATRIX );
        NNS_MATRIX nns_MATRIX2 = new NNS_MATRIX();
    ...
    {
        for ( OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.ObjObjectSearchRegistObject( null, 3 ); obs_OBJECT_WORK != null; obs_OBJECT_WORK = AppMain.ObjObjectSearchRegistObject( obs_OBJECT_WORK, 3 ) )
        {
            AppMain.GMS_ENEMY_3D_WORK gms_ENEMY_3D_WORK = (AppMain.GMS_ENEMY_3D_WORK)obs_OBJECT_WORK;
    ...
    {
        OBS_OBJECT_WORK obj_work_parts = AppMain.GMM_BS_OBJ(body_work);
    ...
    private static void gmBoss2BodyStateStartEnter( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStateStartUpdateWait;
    ...
    private static void gmBoss2BodyStateStartUpdateWait( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStateStartUpdateEnd;
    }
    ...
    private static void gmBoss2BodyStateStartUpdateEnd( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        OBS_OBJECT_WORK obs_OBJECT_WORK2 = AppMain.gmBoss2BodySearchShutterIn();
    ...
    private static void gmBoss2BodyStateCatchMoveEnter( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStateCatchMoveUpdateMove;
    ...
    private static void gmBoss2BodyStateCatchMoveUpdateMove( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.flag &= 4294967279U;
        body_work.proc_update = AppMain.gmBoss2BodyStateCatchMoveUpdateTurn;
        AppMain.gmBoss2EffAfterburnerRequestDelete( body_work );
    }
    ...
    {
        OBS_OBJECT_WORK obj_work = AppMain.GMM_BS_OBJ(body_work);
        AppMain.gmBoss2BodySetActionAllParts( body_work, 2 );
        AppMain.GmBsCmnSetObjSpdZero( obj_work );
        body_work.proc_update = AppMain.gmBoss2BodyStateCatchArmUpdateOpen;
        AppMain.gmBoss2EffAfterburnerRequestDelete( body_work );
    }
    ...
    private static void gmBoss2BodyStateCatchArmUpdateOpen( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStateCatchArmUpdateReady;
    ...
    private static void gmBoss2BodyStateCatchArmUpdateReady( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        obs_OBJECT_WORK.user_timer = 0;
        body_work.proc_update = AppMain.gmBoss2BodyStateCatchArmUpdateDown;
        AppMain.gmBoss2BodySetActionAllParts( body_work, 5 );
        AppMain.gmBoss2BodyCatchChangeArmRectCatch( body_work );
        GmSound.PlaySE( "Boss2_01", body_work.se_handle );
    }
    ...
    private static void gmBoss2BodyStateCatchArmUpdateDown( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStateCatchArmUpdateClose;
        GsSound.StopSE( body_work.se_handle );
        GmSound.PlaySE( "Boss2_02" );
    }
    ...
    {
        OBS_OBJECT_WORK obj_work = AppMain.GMM_BS_OBJ(body_work);
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GmBsCmnGetPlayerObj();
        GMS_PLAYER_WORK gms_PLAYER_WORK = (GMS_PLAYER_WORK)obs_OBJECT_WORK;
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStateCatchArmUpdateUp;
    ...
    private static void gmBoss2BodyStateCatchArmUpdateUp( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_BS_OBJ(body_work);
        OBS_OBJECT_WORK obs_OBJECT_WORK2 = AppMain.GmBsCmnGetPlayerObj();
        GMS_PLAYER_WORK gms_PLAYER_WORK = (GMS_PLAYER_WORK)obs_OBJECT_WORK2;
        body_work.offset_arm += 1f;
        AppMain.gmBoss2BodyCatchSetArmLength( body_work, body_work.offset_arm );
        AppMain.gmBoss2BodyRectApplyOffsetArm( body_work );
        AppMain.gmBoss2BodyCatchArmUpdateShakePlayer( body_work, 1U );
        obs_OBJECT_WORK.dir.x = ( ushort )AkMath.DEGtoA16( body_work.shake_pos );
        if ( ( gms_PLAYER_WORK.player_flag & 1024U ) != 0U )
        {
            body_work.flag &= 4294967287U;
        }
        if ( ( body_work.flag & 8U ) != 0U )
        {
            ...
            OBS_OBJECT_WORK obs_OBJECT_WORK3 = obs_OBJECT_WORK2;
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStateCatchArmUpdateEnd;
    }
    ...
    private static void gmBoss2BodyStateCatchCarryEnter( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStateCatchCarryUpdateMove;
        AppMain.gmBoss2EffAfterburnerRequestCreate( body_work );
    ...
    private static void gmBoss2BodyStateCatchCarryUpdateMove( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStateCatchCarryUpdateOpen;
        AppMain.gmBoss2EffAfterburnerRequestDelete( body_work );
    ...
    private static void gmBoss2BodyStateCatchCarryUpdateOpen( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStateCatchCarryUpdateEnd;
    }
    ...
    private static void gmBoss2BodyStatePreBallEnter( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStatePreBallUpdateAngry;
        AppMain.gmBoss2EffAfterburnerRequestDelete( body_work );
    }
    ...
    private static void gmBoss2BodyStatePreBallUpdateAngry( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStatePreBallUpdateRise;
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStatePreBallUpdateRise;
        GmCamera.ScaleSet( 0.82f, 0.003f );
    }
    ...
    private static void gmBoss2BodyStateBallMoveEnter( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStateBallMoveUpdateMove;
        AppMain.gmBoss2EffAfterburnerRequestCreate( body_work );
        int x;
        if ( ( obs_OBJECT_WORK.disp_flag & 1U ) != 0U )
        {
    ...
    private static void gmBoss2BodyStateBallMoveUpdateMove( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        else
        {
            ...
            AppMain.gmBoss2BodyInitTurn( body_work, dest_angle, 60f, flag_positive );
            body_work.flag &= 4294967279U;
            body_work.proc_update = AppMain.gmBoss2BodyStateBallMoveUpdateTurn;
            AppMain.gmBoss2EffAfterburnerRequestDelete( body_work );
            return;
        }
    }
    ...
    private static void gmBoss2BodyStateBallShootEnter( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        AppMain.GmBsCmnSetObjSpdZero( obj_work );
        body_work.proc_update = AppMain.gmBoss2BodyStateBallShootUpdateWaitCreate;
        AppMain.gmBoss2EffAfterburnerRequestDelete( body_work );
    }
    ...
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_BS_OBJ(body_work);
        OBS_OBJECT_WORK obs_OBJECT_WORK2 = AppMain.GmEventMgrLocalEventBirth(318, obs_OBJECT_WORK.pos.x, obs_OBJECT_WORK.pos.y, 0, 0, 0, 0, 0, 0);
        ...
        AppMain.mtTaskChangeTcbDestructor( obs_OBJECT_WORK2.tcb, AppMain.gmBoss2ExitFunc );
        body_work.proc_update = AppMain.gmBoss2BodyStateBallShootUpdateCatch;
    }
    ...
    private static void gmBoss2BodyStateBallShootUpdateCatch( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStateBallShootUpdateShoot;
    }
    ...
    private static void gmBoss2BodyStatePrePinBallEnter( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        AppMain.GmBsCmnSetObjSpdZero( obj_work );
        body_work.proc_update = AppMain.gmBoss2BodyStatePrePinBallUpdateWaitEffect;
        if ( AppMain.GmBsCmnIsFinalZoneType( obj_work ) == 0 )
        {
            GmSound.ChangeAngryBossBGM();
        }
    }
    ...
    private static void gmBoss2BodyStatePrePinBallUpdateWaitEffect( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        GmSound.PlaySE( "FinalBoss11", body_work.se_handle );
        body_work.proc_update = AppMain.gmBoss2BodyStatePrePinBallUpdateWaitMotion;
    }
    ...
    private static void gmBoss2BodyStatePinBallMoveEnter( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStatePinBallMoveUpdateMove;
        if ( AppMain.GmBsCmnIsFinalZoneType( obs_OBJECT_WORK ) != 0 )
        {
            AppMain.gmBoss2BodyCatchChangeNeedleModeActive();
        }
    ...
    private static void gmBoss2BodyStatePinBallRollEnter( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        AppMain.gmBoss2BodySetActionAllParts( body_work, 15 );
        body_work.proc_update = AppMain.gmBoss2BodyStatePinBallRollUpdateSearch;
    }
    ...
    private static void gmBoss2BodyStatePinBallRollUpdateSearch( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStatePinBallRollUpdateFind;
    }
    ...
    private static void gmBoss2BodyStatePinBallRollUpdateFind( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStatePinBallRollReady;
    }
    ...
    private static void gmBoss2BodyStatePinBallRollReady( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        AppMain.gmBoss2BodySetActionAllParts( body_work, 14 );
        body_work.proc_update = AppMain.gmBoss2BodyStatePinBallRollUpdateMove;
    ...
    private static void gmBoss2BodyStatePinBallRollUpdateMove( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        obs_OBJECT_WORK.user_timer = 0;
        body_work.proc_update = AppMain.gmBoss2BodyStatePinBallRollUpdateStop;
    ...
    private static void gmBoss2BodyStateDefeatEnter( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.ene_3d.ene_com.enemy_flag |= 32768U;
        AppMain.GmBsCmnSetObjSpdZero( obs_OBJECT_WORK );
        body_work.proc_update = AppMain.gmBoss2BodyStateDefeatUpdateStart;
        body_work.flag &= 4294967291U;
        GsSound.StopSE( body_work.se_handle );
        body_work.flag &= 4294967263U;
        AppMain.gmBoss2BodyCatchChangeNeedleModeWait();
        GmSound.ChangeWinBossBGM();
    }
    ...
    private static void gmBoss2BodyStateDefeatUpdateStart( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        obs_OBJECT_WORK.user_timer = 0;
        OBS_OBJECT_WORK obs_OBJECT_WORK2 = AppMain.GMM_BS_OBJ(body_work);
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStateDefeatUpdateFall;
    }
    ...
    private static void gmBoss2BodyStateDefeatUpdateFall( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStateDefeatUpdateExplode;
    }
    ...
    private static void gmBoss2BodyStateDefeatUpdateExplode( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        GmSound.PlaySE( "Boss0_03" );
        AppMain.GMM_PAD_VIB_MID_TIME( 120f );
        AppMain.GmBsCmnInitFlashScreen( body_work.flash_work, 4f, 5f, 30f );
        OBS_OBJECT_WORK obs_OBJECT_WORK2 = AppMain.GMM_BS_OBJ(body_work);
        OBS_OBJECT_WORK obs_OBJECT_WORK3 = (OBS_OBJECT_WORK)AppMain.GmEfctCmnEsCreate(obs_OBJECT_WORK2, 8);
        obs_OBJECT_WORK3.pos.z = obs_OBJECT_WORK2.pos.z + 131072;
        GmPlayer.AddScoreNoDisp( ( GMS_PLAYER_WORK )AppMain.GmBsCmnGetPlayerObj(), 1000 );
        body_work.proc_update = AppMain.gmBoss2BodyStateDefeatUpdateScatter;
    }
    ...
    private static void gmBoss2BodyStateDefeatUpdateScatter( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        body_work.proc_update = AppMain.gmBoss2BodyStateDefeatUpdateEnd;
        AppMain.gmBoss2EffScatterInit( body_work );
        GmCamera.ScaleSet( 1f, 0.0015f );
    ...
    private static void gmBoss2BodyStateEscapeEnter( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        if ( AppMain.GmBsCmnIsFinalZoneType( obs_OBJECT_WORK ) != 0 )
        {
            body_work.proc_update = AppMain.gmBoss2BodyStateEscapeUpdateFinalZone;
        }
        else
        {
            body_work.proc_update = AppMain.gmBoss2BodyStateEscapeUpdateScrollLock;
        }
    ...
    private static void gmBoss2BodyStateEscapeUpdateScrollLock( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        if ( AppMain.gmBoss2BodyEscapeCheckScrollUnlock( body_work ) != 0 )
        {
            ...
            body_work.proc_update = AppMain.gmBoss2BodyStateEscapeUpdateWaitScreenOut;
    ...
    private static void gmBoss2BodyMainFuncWaitSetup( OBS_OBJECT_WORK obj_work )
    {
        ...
        obj_work.ppFunc = AppMain.gmBoss2BodyMainFunc;
    ...
    private static void gmBoss2EggRevertAction( AppMain.GMS_BOSS2_EGG_WORK egg_work )
    {
        ...
        OBS_OBJECT_WORK obs_OBJECT_WORK2 = AppMain.GMM_BS_OBJ(gms_BOSS2_BODY_WORK);
    ...
    {
        egg_work.proc_update = AppMain.gmBoss2EggStateIdleUpdate;
    }
    ...
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_BS_OBJ(egg_work);
        OBS_OBJECT_WORK parent_obj = obs_OBJECT_WORK.parent_obj;
        ...
        egg_work.proc_update = AppMain.gmBoss2EggStateLaughUpdate;
    }
    ...
    private static void gmBoss2EggStateDamageInit( AppMain.GMS_BOSS2_EGG_WORK egg_work )
    {
        ...
        egg_work.proc_update = AppMain.gmBoss2EggStateDamageUpdate;
    }
    ...
    private static void gmBoss2EggStateEscapeInit( AppMain.GMS_BOSS2_EGG_WORK egg_work )
    {
        ...
        egg_work.proc_update = AppMain.gmBoss2EggStateEscapeUpdate;
    }
    ...
    private static void gmBoss2EggmanMainFuncWaitSetup( OBS_OBJECT_WORK obj_work )
    {
        ...
        obj_work.ppFunc = AppMain.gmBoss2EggmanMainFunc;
    ...
    private static void gmBoss2EggmanMainFunc( OBS_OBJECT_WORK obj_work )
    {
        ...
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_BS_OBJ(gms_BOSS2_BODY_WORK);
    ...
    {
        OBS_OBJECT_WORK parent_obj = own_rect.parent_obj;
        OBS_OBJECT_WORK parent_obj2 = parent_obj.parent_obj;
        AppMain.GMS_BOSS2_BODY_WORK gms_BOSS2_BODY_WORK = (AppMain.GMS_BOSS2_BODY_WORK)parent_obj2;
        gms_BOSS2_BODY_WORK.flag |= 268435456U;
    }
    ...
    private static void gmBoss2BallMainFuncWaitSetup( OBS_OBJECT_WORK obj_work )
    {
        ...
        OBS_OBJECT_WORK obj_work_parts = AppMain.GMM_BS_OBJ(obj);
        AppMain.GMS_BOSS2_MGR_WORK mgr_work = AppMain.gmBoss2MgrGetMgrWork(obj_work_parts);
        if ( AppMain.gmBoss2MgrCheckSetupComplete( mgr_work ) == 0 )
        {
            return;
        }
        obj_work.ppFunc = AppMain.gmBoss2BallMainFunc;
    ...
    {
        ball_work.proc_update = AppMain.gmBoss2BallUpdateCatch;
    }
    ...
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_BS_OBJ(ball_work);
        AppMain.GMS_BOSS2_BODY_WORK gms_BOSS2_BODY_WORK = (AppMain.GMS_BOSS2_BODY_WORK)obs_OBJECT_WORK.parent_obj;
        ...
        ball_work.proc_update = AppMain.gmBoss2BallUpdateWaitShoot;
    }
    ...
    private static void gmBoss2BallUpdateWaitShoot( AppMain.GMS_BOSS2_BALL_WORK ball_work )
    {
        ...
        ball_work.proc_update = AppMain.gmBoss2BallUpdateShoot;
        obs_OBJECT_WORK.move_flag |= 128U;
    }
    ...
    private static void gmBoss2BallUpdateShoot( AppMain.GMS_BOSS2_BALL_WORK ball_work )
    {
        ...
        ball_work.proc_update = AppMain.gmBoss2BallUpdateWaitBomb;
    }
    ...
    private static void gmBoss2BallUpdateWaitBomb( AppMain.GMS_BOSS2_BALL_WORK ball_work )
    {
        ...
        obs_OBJECT_WORK.user_timer = 0;
        ball_work.proc_update = AppMain.gmBoss2BallUpdateFlicker;
    ...
    private static void gmBoss2BallUpdateFlicker( AppMain.GMS_BOSS2_BALL_WORK ball_work )
    {
        ...
        OBS_OBJECT_WORK obs_OBJECT_WORK2 = (OBS_OBJECT_WORK)work;
    ...
    private static void gmBoss2EffDamageInit( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_BS_OBJ(obj);
        OBS_OBJECT_WORK obs_OBJECT_WORK2 = obs_OBJECT_WORK;
        obs_OBJECT_WORK2.pos.z = obs_OBJECT_WORK2.pos.z + 131072;
    }

    // Token: 0x06001303 RID: 4867 RVA: 0x000A51DC File Offset: 0x000A33DC
    private static void gmBoss2EffBombsInit( AppMain.GMS_BOSS2_EFF_BOMB_WORK bomb_work, OBS_OBJECT_WORK parent_obj, int pos_x, int pos_y, int width, int height, uint interval_min, uint interval_max )
    {
    ...
    private static void gmBoss2EffBombsUpdate( AppMain.GMS_BOSS2_EFF_BOMB_WORK bomb_work )
    {
        ...
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_BS_OBJ(obj);
        OBS_OBJECT_WORK obs_OBJECT_WORK2 = AppMain.GMM_BS_OBJ(bomb_work.parent_obj);
    ...
    private static void gmBoss2EffAfterburnerInit( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        obs_OBJECT_WORK.ppFunc = AppMain.gmBoss2EffAfterburnerMainFunc;
    }
    ...
    private static void gmBoss2EffAfterburnerSmokeInit( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_BS_OBJ(gms_EFFECT_3DES_WORK);
        obs_OBJECT_WORK.ppFunc = AppMain.gmBoss2EffAfterburnerSmokeMainFunc;
    }
    ...
    private static void gmBoss2EffBodySmokeInit( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        AppMain.GmEffect3DESAddDispOffset( gms_EFFECT_3DES_WORK, 0f, 0f, -32f );
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_BS_OBJ(gms_EFFECT_3DES_WORK);
        obs_OBJECT_WORK.ppFunc = AppMain.gmBoss2EffBodySmokeMainFunc;
    }
    ...
    {
        OBS_OBJECT_WORK parent_obj = AppMain.GMM_BS_OBJ(egg_work);
        ...
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_BS_OBJ(gms_EFFECT_3DES_WORK);
        obs_OBJECT_WORK.ppFunc = AppMain.gmBoss2EffSweatMainFunc;
        egg_work.flag |= 2U;
    }
    ...
    private static OBS_OBJECT_WORK gmBoss2EffInit( AppMain.OBS_DATA_WORK data_work, int effect_type, OBS_OBJECT_WORK parent_obj_work, short rot_x, short rot_y, short rot_z, float offset_x, float offset_y, float offset_z, int flag_flip, int flag_data_rotate )
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_EFFECT_CREATE_WORK(() => new AppMain.GMS_EFFECT_3DES_WORK(), null, 0, "B02_effect");
    ...
    private static void gmBoss2EffBallBombInit( AppMain.VecFx32 create_pos, OBS_OBJECT_WORK body_obj_work )
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.gmBoss2EffInit(AppMain.ObjDataGet(717), 1, null, 0, 0, 0, 0f, 0f, 0f, 0, 0);
        ...
        AppMain.mtTaskChangeTcbDestructor( obs_OBJECT_WORK.tcb, AppMain.gmBoss2EffectExitFunc );
    }

    // Token: 0x06001311 RID: 4881 RVA: 0x000A575C File Offset: 0x000A395C
    private static OBS_OBJECT_WORK gmBoss2EffBallBombPartInit( AppMain.VecFx32 create_pos, OBS_OBJECT_WORK body_obj_work, int spd_x )
    {
        ...
        rect_work[1].ppHit = AppMain.gmBoss2BallHitFunc;
        ...
        obj_work.ppFunc = AppMain.gmBoss2EffBallBombPartMainFunc;
        AppMain.GMS_BOSS2_MGR_WORK mgr_work = AppMain.gmBoss2MgrGetMgrWork(body_obj_work);
        AppMain.gmBoss2MgrAddObject( mgr_work, obj_work );
        AppMain.mtTaskChangeTcbDestructor( obj_work.tcb, AppMain.gmBoss2EffectExitFunc );
        return obj_work;
    }
    ...
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_BS_OBJ(body_work);
        OBS_OBJECT_WORK obs_OBJECT_WORK2 = AppMain.gmBoss2EffInit(AppMain.ObjDataGet(714), 2, obs_OBJECT_WORK, 0, 0, 0, 24f, 0f, 0f, 0, 0);
        obs_OBJECT_WORK2.ppFunc = AppMain.gmBoss2EffBlitzMainFuncBlitzCoreL;
        OBS_OBJECT_WORK obs_OBJECT_WORK3 = AppMain.gmBoss2EffInit(AppMain.ObjDataGet(714), 2, obs_OBJECT_WORK, 0, 0, 0, -24f, 0f, 0f, 0, 0);
        obs_OBJECT_WORK3.ppFunc = AppMain.gmBoss2EffBlitzMainFuncBlitzCoreR;
        OBS_OBJECT_WORK obs_OBJECT_WORK4 = AppMain.gmBoss2EffInit(AppMain.ObjDataGet(715), 2, obs_OBJECT_WORK, 0, 0, AppMain.GMD_BOSS2_EFFECT_BLITZ_LINE_DISP_ROT_Z, 0f, -30f, 0f, 0, 0);
        obs_OBJECT_WORK4.ppFunc = AppMain.gmBoss2EffBlitzMainFuncBlitzLineCreate;
        body_work.flag |= 4U;
        AppMain.GMS_BOSS2_MGR_WORK mgr_work = AppMain.gmBoss2MgrGetMgrWork(obs_OBJECT_WORK);
        AppMain.gmBoss2MgrAddObject( mgr_work, obs_OBJECT_WORK2 );
        AppMain.gmBoss2MgrAddObject( mgr_work, obs_OBJECT_WORK3 );
        AppMain.gmBoss2MgrAddObject( mgr_work, obs_OBJECT_WORK4 );
        AppMain.mtTaskChangeTcbDestructor( obs_OBJECT_WORK2.tcb, AppMain.gmBoss2EffectExitFunc );
        AppMain.mtTaskChangeTcbDestructor( obs_OBJECT_WORK3.tcb, AppMain.gmBoss2EffectExitFunc );
        AppMain.mtTaskChangeTcbDestructor( obs_OBJECT_WORK4.tcb, AppMain.gmBoss2EffectExitFunc );
    }
    ...
    private static void gmBoss2EffBlitzMainFuncBlitzLineCreate( OBS_OBJECT_WORK obj_work )
    {
        ...
        obj_work.ppFunc = AppMain.gmBoss2EffBlitzMainFuncBlitzLineNormal;
    }
    ...
    private static void gmBoss2EffScatterInit( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        while ( 13 > num )
        {
            ...
            gms_BS_CMN_NODE_CTRL_OBJECT.proc_update = AppMain.gmBoss2EffScatterMainFunc;
            OBS_OBJECT_WORK obj_work = gms_BS_CMN_NODE_CTRL_OBJECT.efct_com.obj_work;
            obj_work.move_flag |= 128U;
            if ( num == 4 || num == 5 || num == 7 || num == 8 )
            {
                OBS_OBJECT_WORK obj_work2 = gms_BOSS2_EFFECT_SCATTER_WORK.control_node_work.efct_com.obj_work;
    ...
    private static void gmBoss2EffScatterSetParamMove( OBS_OBJECT_WORK obj_work, int right_flag )
    {
        ...
        int ang = AkMath.DEGtoA32(num + 90);
    ...
    private static void gmBoss2EffCreateRollModel( AppMain.GMS_BOSS2_BODY_WORK body_work )
    {
        ...
        if ( ( obs_OBJECT_WORK.disp_flag & 1U ) != 0U )
        {
            y = ( short )AkMath.DEGtoA32( -90f );
        }
        else
        {
            y = ( short )AkMath.DEGtoA32( 90f );
        }
        AppMain.GMS_EFFECT_CREATE_PARAM create_param = new AppMain.GMS_EFFECT_CREATE_PARAM(11, 0U, 19U, new NNS_VECTOR(0f, 0f, 64f), new NNS_ROTATE_A16(0, y, 0), 3.2f, AppMain.GmEffectDefaultMainFuncDeleteAtEnd, 5);
        OBS_OBJECT_WORK obs_OBJECT_WORK2 = (OBS_OBJECT_WORK)AppMain.GmEffect3dESCreateByParam(create_param, obs_OBJECT_WORK, AppMain.GmBoss2GetGameDatEnemyArc(), AppMain.ObjDataGet(719), AppMain.ObjDataGet(726), AppMain.ObjDataGet(727), AppMain.ObjDataGet(725), AppMain.ObjDataGet(724), () => new AppMain.GMS_EFFECT_3DES_WORK());
        obs_OBJECT_WORK2.ppFunc = AppMain.gmBoss2EffRollModelMainFunc;
