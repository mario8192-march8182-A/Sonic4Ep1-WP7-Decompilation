...
public partial class AppMain
{
    ...
    public static OBS_OBJECT_WORK GMM_ENEMY_CREATE_RIDE_WORK(AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y,
    ...
    private static void GmEnemyDefaultExit(MTS_TASK_TCB tcb)
    {
        ...
        if (gms_ENEMY_COM_WORK.eve_rec != null && gms_ENEMY_COM_WORK.eve_rec.pos_x == 255 &&
            gms_ENEMY_COM_WORK.eve_rec.pos_y == 255)
        {
