...
public partial class AppMain
{
    ...
    {
        get { return AppMain.GMM_BOSS4_STAGE<int>(3, 4); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_STAGE<int>(1, 2); }
    }
    ...
    {
        get { return (uint) AppMain.GMM_BOSS4_PAL_TIME(300f); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_PAL_SPEED(1f); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_PAL_SPEED(2f); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_PAL_SPEED(-4.5f); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_PAL_SPEED(-3.5f); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_PAL_SPEED(0.1f); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_PAL_SPEED(0.2f); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_PAL_SPEED(0.18f); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_PAL_TIME(10f); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_PAL_SPEED(0.8f); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_PAL_SPEED(1.5f); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_PAL_SPEED(-1.2f); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_PAL_SPEED(-2.5f); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_PAL_ZOOM(1.04f); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_PAL_ZOOM(0.95f); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_PAL_ZOOM(0.9f); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_PAL_ZOOM(1.15f); }
    }
    ...
    {
        get { return (float) AppMain.GMM_BOSS4_PAL_TIME(2f); }
    }
    ...
    {
        get { return (float) AppMain.GMM_BOSS4_PAL_TIME(60f); }
    }
    ...
    private static int gmBoss4ChibiGetAttackType(int life)
    {
        ...
        {
            if (AppMain.GmBoss4GetLife() < AppMain.GME_BOSS4_LIFE_H &&
                AppMain.GmBoss4GetLife() > AppMain.GME_BOSS4_LIFE_L)
            {
                num = AppMain.gmBoss4ChibiGetAttackTypeStatics.life2_tbl_f[
                    AppMain.gmBoss4ChibiGetAttackTypeStatics._index];
            }
            else
            {
                num = AppMain.gmBoss4ChibiGetAttackTypeStatics.life1_tbl_f[
                    AppMain.gmBoss4ChibiGetAttackTypeStatics._index];
            }
        }
        else if (AppMain.GmBoss4GetLife() < AppMain.GME_BOSS4_LIFE_H &&
                 AppMain.GmBoss4GetLife() > AppMain.GME_BOSS4_LIFE_L)
        {
    ...
    private static OBS_OBJECT_WORK GmBoss4ChibiInit1st(AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y,
        byte type)
    {
    ...
    private static OBS_OBJECT_WORK GmBoss4ChibiInit2nd(AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y,
        byte type)
    {
        AppMain.UNREFERENCED_PARAMETER(type);
    ...
    private static OBS_OBJECT_WORK GmBoss4ChibiInit2ndSpeed(AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y,
        byte type)
    {
        AppMain.UNREFERENCED_PARAMETER(type);
    ...
    private static OBS_OBJECT_WORK GmBoss4ChibiInit2ndBig(AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y,
        byte type)
    {
        AppMain.UNREFERENCED_PARAMETER(type);
    ...
    private static OBS_OBJECT_WORK GmBoss4ChibiInit2ndIron(AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y,
        byte type)
    {
        AppMain.UNREFERENCED_PARAMETER(type);
    ...
    private static OBS_OBJECT_WORK GmBoss4ChibiInit(AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y,
        int type)
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_ENEMY_CREATE_WORK(eve_rec, pos_x, pos_y,
            () => new AppMain.GMS_BOSS4_CHIBI_WORK(), "BOSS4_C.E");
        ...
        {
            default:
                AppMain.ObjObjectCopyAction3dNNModel(obs_OBJECT_WORK, AppMain.GmBoss4GetObj3D(3),
                    gms_ENEMY_3D_WORK.obj_3d);
                break;
            case 2:
                AppMain.ObjObjectCopyAction3dNNModel(obs_OBJECT_WORK, AppMain.GmBoss4GetObj3D(4),
                    gms_ENEMY_3D_WORK.obj_3d);
                break;
            case 3:
                AppMain.ObjObjectCopyAction3dNNModel(obs_OBJECT_WORK, AppMain.GmBoss4GetObj3D(5),
                    gms_ENEMY_3D_WORK.obj_3d);
                break;
            case 4:
                AppMain.ObjObjectCopyAction3dNNModel(obs_OBJECT_WORK, AppMain.GmBoss4GetObj3D(6),
                    gms_ENEMY_3D_WORK.obj_3d);
                break;
        }
    ...
    private static void gmBoss4ChibiAtkHitFunc(AppMain.OBS_RECT_WORK my_rect, AppMain.OBS_RECT_WORK your_rect)
    {
        ...
        if (gms_BOSS4_CHIBI_WORK.type != 0)
        {
            GMS_PLAYER_WORK ply_work = (GMS_PLAYER_WORK) AppMain.GmBsCmnGetPlayerObj();
            if (GmPlayer.KeyCheckWalkLeft(ply_work))
            {
    ...
    private static void gmBoss4ChibiDefHitFunc(AppMain.OBS_RECT_WORK my_rect, AppMain.OBS_RECT_WORK your_rect)
    {
        ...
        OBS_OBJECT_WORK obs_OBJECT_WORK = (OBS_OBJECT_WORK) gms_BOSS4_CHIBI_WORK;
        OBS_OBJECT_WORK obs_OBJECT_WORK2 = (OBS_OBJECT_WORK) gms_BOSS4_CHIBI_WORK2;
        ...
        if (obs_OBJECT_WORK.pos.x > obs_OBJECT_WORK2.pos.x)
        {
            ...
            obs_OBJECT_WORK4.spd.x =
                obs_OBJECT_WORK4.spd.x + AppMain.FX_F32_TO_FX32(AppMain.GMD_BOSS4_CHIBI_HIT_CHIBI_ADDSPD);
        }
        ...
        if (obs_OBJECT_WORK.pos.x < obs_OBJECT_WORK2.pos.x)
        {
            ...
            obs_OBJECT_WORK6.spd.x =
                obs_OBJECT_WORK6.spd.x - AppMain.FX_F32_TO_FX32(AppMain.GMD_BOSS4_CHIBI_HIT_CHIBI_ADDSPD);
        }
        ...
        if (obs_OBJECT_WORK.pos.x == obs_OBJECT_WORK2.pos.x)
        {
            if (obs_OBJECT_WORK.pos.y < obs_OBJECT_WORK.pos.y)
            {
                ...
                obs_OBJECT_WORK8.spd.x = obs_OBJECT_WORK8.spd.x +
                                         AppMain.FX_F32_TO_FX32(AppMain.GMD_BOSS4_CHIBI_HIT_CHIBI_ADDSPD);
            }
            else
            {
                OBS_OBJECT_WORK obs_OBJECT_WORK9 = obs_OBJECT_WORK;
                obs_OBJECT_WORK9.pos.x = obs_OBJECT_WORK9.pos.x - AppMain.FX_F32_TO_FX32(4f);
                OBS_OBJECT_WORK obs_OBJECT_WORK10 = obs_OBJECT_WORK;
                obs_OBJECT_WORK10.spd.x = obs_OBJECT_WORK10.spd.x -
                                          AppMain.FX_F32_TO_FX32(AppMain.GMD_BOSS4_CHIBI_HIT_CHIBI_ADDSPD);
            }
        }
    ...
    private static void gmBoss4ChibiWaitLoad(OBS_OBJECT_WORK obj_work)
    {
        ...
        if (AppMain.GmBoss4IsBuilded())
        {
            ...
            AppMain.GmBoss4UtilInitFlicker(obj_work, gms_BOSS4_CHIBI_WORK.flk_work, 1, 180, 4,
                (int) (gms_BOSS4_CHIBI_WORK.timer.timer / 20U * 3U), AppMain.gm_boss4_color_red);
    ...
    private static void gmBoss4ChibiMain(OBS_OBJECT_WORK obj_work)
    {
        ...
        if ((obj_work.move_flag & 1U) != 0U)
        {
            ...
            {
                GmSound.PlaySE("Boss4_03");
            }
            else if (gms_BOSS4_CHIBI_WORK.type != 4)
            {
                GmSound.PlaySE("Boss4_02");
            }
        }
            ...
            if (--gms_BOSS4_CHIBI_WORK.bound == 0)
            {
                ...
                switch (gms_BOSS4_CHIBI_WORK.type)
                {
                    default:
                        ...
                        {
                            obj_work.spd.x =
                                (int) ((float) obj_work.spd.x * AppMain.GMD_BOSS4_CHIBI_BOUND_MULTI_SPD_X) -
                                AppMain.FX_F32_TO_FX32(AppMain.GMD_BOSS4_CHIBI_BOUND_ADD_SPD_X);
                        }
                        else
                        {
                            obj_work.spd.x =
        ...
        if (gms_BOSS4_CHIBI_WORK.type == 0 && AppMain.GmBoss4UtilUpdateFlicker(obj_work, gms_BOSS4_CHIBI_WORK.flk_work))
        {
            ...
            AppMain.GmBoss4UtilInitFlicker(obj_work, gms_BOSS4_CHIBI_WORK.flk_work, 1, start, 2, 0,
                AppMain.gm_boss4_color_red);
        }
    ...
    private static void gmBoss4ChibiFuncBoost(OBS_OBJECT_WORK obj_work)
    {
        ...
        if (gms_BOSS4_CHIBI_WORK.dir.cur_angle < AkMath.DEGtoA16(50) &&
            gms_BOSS4_CHIBI_WORK.dir.cur_angle > AkMath.DEGtoA16(-50))
        {
            obj_work.disp_flag |= 32U;
        }

        AppMain.GmBsCmnUpdateObject3DESStuckWithNode(obj_work, gms_BOSS4_CHIBI_WORK.node_work.snm_work,
            gms_BOSS4_CHIBI_WORK.node_work.work[0], 1);
    ...
    private static void gmBoss4ChibiBoosterDelete(AppMain.GMS_BOSS4_CHIBI_WORK chibi)
    {
        if (chibi.boost != null)
        {
            AppMain.ObjDrawKillAction3DES((OBS_OBJECT_WORK) chibi.boost);
            chibi.boost = null;
        }
    }
    ...
    public static AMS_AMB_HEADER GMD_BOSS4_ARC
    {
        get { return AppMain.g_gm_gamedat_enemy_arc; }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_STAGE<int>(2500, 11000); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_STAGE<int>(3972, 12536); }
    }
    ...
    {
        get { return AppMain.GMM_BOSS4_STAGE<int>(8, 4); }
    }
    ...
    private static OBS_OBJECT_WORK GMM_BOSS4_CREATE_WORK(AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y,
    ...
    private static OBS_OBJECT_WORK GmBoss4GetBodyWork()
    {
        ...
        return (OBS_OBJECT_WORK) AppMain.gm_boss4_mgr_work.body_work;
    }
    ...
    private static void GmBoss4Build()
    {
        ...
        AppMain.gm_boss4_obj_3d_list =
            AppMain.GmGameDBuildRegBuildModel((AMS_AMB_HEADER) obj, (AMS_AMB_HEADER) obj2, 0U);
    ...
    private static void GmBoss4Flush()
    {
        ...
        AMS_AMB_HEADER ams_AMB_HEADER = (AMS_AMB_HEADER) AppMain.ObjDataLoadAmbIndex(null, 0, AppMain.GMD_BOSS4_ARC);
    ...
    private static OBS_OBJECT_WORK GmBoss4Init(AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y, byte type)
    {
        AppMain.UNREFERENCED_PARAMETER(type);
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_BOSS4_CREATE_WORK(eve_rec, pos_x, pos_y,
            () => new AppMain.GMS_BOSS4_MGR_WORK(), "Boss4_MGR");
    ...
    private static void gmBoss4MgrWaitLoad(OBS_OBJECT_WORK obj_work)
    {
        ...
        if (flag)
        {
            OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GmEventMgrLocalEventBirth(321, x, y, 0, 0, 0, 0, 0, 0);
            AppMain.GmBoss4IncObjCreateCount();
            OBS_OBJECT_WORK obs_OBJECT_WORK2 = AppMain.GmEventMgrLocalEventBirth(322, x, y, 0, 0, 0, 0, 0, 0);
            AppMain.GmBoss4IncObjCreateCount();
            AppMain.GmBoss4CapsuleClear();
            for (int i = 0; i < 6; i++)
            {
                OBS_OBJECT_WORK obs_OBJECT_WORK3 = AppMain.GmEventMgrLocalEventBirth(323, x, y, 0, 0, 0, 0, 0, 0);
    ...
    private static void gmBoss4MgrMain(OBS_OBJECT_WORK obj_work)
    {
        ...
        if (AppMain.gm_boss4_n_scroll != 0 || AppMain.gm_boss4_f_scroll_spd > 0f)
        {
            ...
            NNS_VECTOR nns_VECTOR =
                new NNS_VECTOR(AppMain.FX_FX32_TO_F32(AppMain.GmBoss4GetScrollOffset()), 0f, 0f);
            if (nns_VECTOR.x < 0f)
            {
            ...
            OBS_OBJECT_WORK obs_OBJECT_WORK4 = (OBS_OBJECT_WORK) body_work;
            if (obs_OBJECT_WORK4 != null)
            {
                OBS_OBJECT_WORK obs_OBJECT_WORK5 = obs_OBJECT_WORK4;
                obs_OBJECT_WORK5.pos.x = obs_OBJECT_WORK5.pos.x + AppMain.GmBoss4GetScrollOffset();
                OBS_OBJECT_WORK obs_OBJECT_WORK6 = obs_OBJECT_WORK4;
                ...
                {
                    OBS_OBJECT_WORK obs_OBJECT_WORK7 = obs_OBJECT_WORK4;
                    obs_OBJECT_WORK7.pos.x = obs_OBJECT_WORK7.pos.x +
                                             AppMain.FX_F32_TO_FX32(AppMain.GMD_BOSS4_SCROLL_SPD_BOSS);
                }
                else
                {
                    OBS_OBJECT_WORK obs_OBJECT_WORK8 = obs_OBJECT_WORK4;
                    obs_OBJECT_WORK8.pos.x = obs_OBJECT_WORK8.pos.x +
                                             AppMain.FX_F32_TO_FX32(AppMain.GMD_BOSS4_SCROLL_SPD_BOSS_BROKEN);
                }
    ...
    private static void gmCameraForceScrollFunc(OBS_CAMERA obj_cam)
    {
        ...
        obj_cam.target_pos.x = (float) AppMain.gm_boss4_n_scroll_pt_x + gmCameraForceScrollFuncStatics.ofst;
        AppMain.ObjObjectCameraSet(AppMain.FXM_FLOAT_TO_FX32(obj_cam.disp_pos.x - (float) (AppMain.OBD_LCD_X / 2)),
            AppMain.FXM_FLOAT_TO_FX32(-obj_cam.disp_pos.y - (float) (AppMain.OBD_LCD_Y / 2)),
            AppMain.FXM_FLOAT_TO_FX32(obj_cam.disp_pos.x - (float) (AppMain.OBD_LCD_X / 2)),
            AppMain.FXM_FLOAT_TO_FX32(-obj_cam.disp_pos.y - (float) (AppMain.OBD_LCD_Y / 2)));
        GmCamera.SetClipCamera(obj_cam);
        ...
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GmBsCmnGetPlayerObj();
        gmCameraForceScrollFuncStatics.ofst = (AppMain.AMD_SCREEN_2D_WIDTH / (float) AppMain.GSD_DISP_WIDTH - 1f) *
            ((float) (obs_OBJECT_WORK.pos.x / 4096) - obj_cam.pos.x) / 30f;
        bool enable = false;
        if (AppMain.gm_boss4_n_scroll == 1 || AppMain.gm_boss4_n_scroll == 2)
        {
            enable = true;
        ...
        if (AppMain.gm_boss4_n_scroll == 2)
        {
            ...
            {
                GmPlayer.SetAutoRun((GMS_PLAYER_WORK) obs_OBJECT_WORK, (int) ((num2 + 0.6f) * 4096f), enable);
            }
            else
            {
                GmPlayer.SetAutoRun((GMS_PLAYER_WORK) obs_OBJECT_WORK, (int) ((num2 + 1.4f) * 4096f), enable);
            }
        }
        else
        {
            GmPlayer.SetAutoRun((GMS_PLAYER_WORK) obs_OBJECT_WORK, (int) ((num2 + -0.5f) * 4096f), enable);
        }
        ...
        {
            AppMain.gm_boss4_n_offset_x = -(AppMain.gm_boss4_n_scroll_end - AppMain.gm_boss4_n_scroll_start) +
                                          (int) AppMain.gm_boss4_f_scroll_spd;
            AppMain.gm_boss4_n_scroll_pt_x -= AppMain.gm_boss4_n_scroll_end - AppMain.gm_boss4_n_scroll_start;
        }

        AppMain.g_gm_main_system.map_fcol.left =
    ...
    private static OBS_OBJECT_WORK GmBoss4ScrollInit(AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y,
        byte type)
    {
        AppMain.UNREFERENCED_PARAMETER(type);
        ...
        ObjCamera.SetUserFunc(0, gmCameraForceScrollFunc);
    ...
    {
        return AppMain.gm_boss4_mgr_work != null &&
               0 != AppMain.GmBsCmnIsFinalZoneType(AppMain.gm_boss4_mgr_work.Cast());
    }
