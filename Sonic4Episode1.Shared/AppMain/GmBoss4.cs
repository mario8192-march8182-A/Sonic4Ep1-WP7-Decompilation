...
public partial class AppMain
{
    ...
    private static void gmCameraForceScrollFunc( AppMain.OBS_CAMERA obj_cam )
    {
        ...
        AppMain.g_gm_main_system.map_fcol.left = AppMain.gm_boss4_n_scroll_pt_x - ( int )( AppMain.AMD_SCREEN_2D_WIDTH / 2f * 0.75f ) - 48;
        AppMain.g_gm_main_system.map_fcol.right = AppMain.gm_boss4_n_scroll_pt_x + ( int )( AppMain.AMD_SCREEN_2D_WIDTH / 2f * 0.75f );
