...
public partial class AppMain
{
    ...
    public static OBS_OBJECT_WORK GmBoss5CtpltInit( AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y, byte type )
    {
        AppMain.UNREFERENCED_PARAMETER( type );
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_ENEMY_CREATE_WORK(eve_rec, pos_x, pos_y, () => new AppMain.GMS_BOSS5_CTPLT_WORK(), "BOSS5_CTPLT");
    ...
    public static void GmBoss5CtpltCreate( AppMain.GMS_BOSS5_BODY_WORK body_work )
    {
        ...
        OBS_OBJECT_WORK obs_OBJECT_WORK2 = AppMain.GmEventMgrLocalEventBirth(345, obs_OBJECT_WORK.pos.x, obs_OBJECT_WORK.pos.y, 0, 0, 0, 0, 0, 0);
    ...
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.GMM_BS_OBJ(ctplt_work);
