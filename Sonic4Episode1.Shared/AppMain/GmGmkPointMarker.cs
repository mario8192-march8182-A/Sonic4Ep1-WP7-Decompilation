...
public class GmGmkPointMarker
{
    ...
    public class GMS_GMK_PMARKER_WORK : IOBS_OBJECT_WORK
    {
        ...
        {
            get { return this.gmk_work.obj_3d; }
        }
        ...
        {
            get { return this.gmk_work.ene_com; }
        }
        ...
        {
            get { return this.COMWORK.obj_work; }
        }
    ...
    {
        gm_gmk_pmarker_obj_3d_list = AppMain.GmGameDBuildRegBuildModel(AppMain.GmGameDatGetGimmickData(838),
            AppMain.GmGameDatGetGimmickData(839), 0U);
    }
    ...
    public static void Flush()
    {
        ...
        AppMain.GmGameDBuildRegFlushModel(gm_gmk_pmarker_obj_3d_list, ams_AMB_HEADER.file_num);
    }
    ...
    private static void gmGmkPointMarkerStay_200(OBS_OBJECT_WORK obj_work)
    {
        ...
        obj_work.ppFunc = gmGmkPointMarkerStay_210;
    }
    ...
    private static void gmGmkPointMarkerStay_400(OBS_OBJECT_WORK obj_work)
    {
        ...
        AppMain.ObjAction3dNNMaterialMotionLoad(obj_work.obj_3d, 0, null, null, 0,
            (AMS_AMB_HEADER) AppMain.ObjDataGet(841).pData);
    ...
    {
        var gms_GMK_PMARKER_WORK = (GMS_GMK_PMARKER_WORK) obj_work;
        AppMain.ObjObjectCopyAction3dNNModel(obj_work, gm_gmk_pmarker_obj_3d_list[0],
            gms_GMK_PMARKER_WORK.OBJ_3D);
        AppMain.ObjObjectAction3dNNMotionLoad(obj_work, 0, false, AppMain.ObjDataGet(840), null, 0, null);
        AppMain.ObjDrawObjectActionSet(obj_work, 0);
        if (AppMain.g_gm_main_system.marker_pri < (uint) gms_GMK_PMARKER_WORK.marker_prty)
        {
            gms_GMK_PMARKER_WORK.COMWORK.rect_work[0].flag &= 0b11111111_11111111_11111111_11111011U;
            gms_GMK_PMARKER_WORK.COMWORK.rect_work[1].flag &= 0b11111111_11111111_11111111_11111011U;
            AppMain.OBS_RECT_WORK obs_RECT_WORK = gms_GMK_PMARKER_WORK.COMWORK.rect_work[2];
            obs_RECT_WORK.ppDef = gmGmkPointMarkerHit;
