...
public partial class AppMain
{
    ...
    private static AppMain.GMS_EFFECT_3DES_WORK GmBoss4EffCommonInit( int id, AppMain.VecFx32? pos, OBS_OBJECT_WORK parent_obj )
    {
    ...
    private static void GmBoss4EffBombInitCreate( AppMain.GMS_BOSS4_EFF_BOMB_WORK bomb_work, int bomb_type, OBS_OBJECT_WORK parent_obj, int pos_x, int pos_y, int width, int height, uint interval_min, uint interval_max )
    {
