...
public partial class AppMain
{
    ...
    {
        AppMain.dm_stfrl_sonic_obj_3d_list = AppMain.GmGameDBuildRegBuildModel( AmFs.readAMBFile(GmPlayer.g_gm_player_data_work[( int )( ( UIntPtr )0 )][0].pData ), AmFs.readAMBFile( GmPlayer.g_gm_player_data_work[( int )( ( UIntPtr )0 )][1].pData ), 0U );
    }
    ...
    {
        AMS_AMB_HEADER mdl_amb = AmFs.readAMBFile(AppMain.ObjDataLoadAmbIndex(null, 0, AppMain.g_gm_gamedat_enemy_arc));
        AMS_AMB_HEADER tex_amb = AmFs.readAMBFile(AppMain.ObjDataLoadAmbIndex(null, 1, AppMain.g_gm_gamedat_enemy_arc));
    ...
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.OBM_OBJECT_TASK_DETAIL_INIT(24576, 0, 0, 0, () => new AppMain.DMS_STFRL_BOSS_BODY_WORK(), "BOSS1_BODY");
    ...
    private static AppMain.DMS_STFRL_BOSS_EGG_WORK DmStfrlMdlCtrlSetEggObj( OBS_OBJECT_WORK body_work )
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.OBM_OBJECT_TASK_DETAIL_INIT(24576, 0, 0, 0, () => new AppMain.DMS_STFRL_BOSS_EGG_WORK(), "BOSS1_EGG");
    ...
    {
        OBS_OBJECT_WORK obs_OBJECT_WORK = AppMain.OBM_OBJECT_TASK_DETAIL_INIT(24576, 0, 0, 0, () => new AppMain.DMS_STFRL_RING_WORK(), "RING_OBJ");
        ...
        AppMain.ObjObjectAction3dNNMaterialMotionLoad( obs_OBJECT_WORK, 0, null, null, 0, AmFs.readAMBFile( AppMain.ObjDataGet( 4 ).pData ) );
        obs_OBJECT_WORK.disp_flag |= 4194309U;
        obs_OBJECT_WORK.disp_flag &= 4294967263U;
        obs_OBJECT_WORK.disp_flag |= 150995456U;
        obs_OBJECT_WORK.obj_3d.drawflag |= 8388608U;
