...
public partial class AppMain
{
    ...
    public class GMS_GMK_STOPPER_WORK : IOBS_OBJECT_WORK
    {
        ...
        public static explicit operator OBS_OBJECT_WORK(AppMain.GMS_GMK_STOPPER_WORK work)
        {
    ...
    private static void gmGmkStopperStart(OBS_OBJECT_WORK obj_work)
    {
        ...
        AppMain.ObjRectWorkSet(obs_RECT_WORK, AppMain.tbl_gm_gmk_piston_col_rect[4],
            AppMain.tbl_gm_gmk_piston_col_rect[5], AppMain.tbl_gm_gmk_piston_col_rect[6],
            AppMain.tbl_gm_gmk_piston_col_rect[7]);
    ...
    private static void gmGmkStopperExit(AppMain.MTS_TASK_TCB tcb)
    {
        ...
        if (gms_GMK_STOPPER_WORK.se_handle != null)
        {
            GsSound.StopSeHandle(gms_GMK_STOPPER_WORK.se_handle);
            GsSound.FreeSeHandle(gms_GMK_STOPPER_WORK.se_handle);
            gms_GMK_STOPPER_WORK.se_handle = null;
        }
    ...
    private static OBS_OBJECT_WORK GmGmkStopperNormInit(AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y,
        byte type)
    {
        AppMain.UNREFERENCED_PARAMETER(type);
        AppMain.GMS_GMK_STOPPER_WORK gms_GMK_STOPPER_WORK =
            (AppMain.GMS_GMK_STOPPER_WORK) AppMain.GMM_ENEMY_CREATE_WORK(eve_rec, pos_x, pos_y,
                () => new AppMain.GMS_GMK_STOPPER_WORK(), "Gmk_StopperRod");
        OBS_OBJECT_WORK obs_OBJECT_WORK = (OBS_OBJECT_WORK) gms_GMK_STOPPER_WORK;
        AppMain.GMS_ENEMY_3D_WORK gms_ENEMY_3D_WORK = (AppMain.GMS_ENEMY_3D_WORK) gms_GMK_STOPPER_WORK;
        AppMain.ObjObjectCopyAction3dNNModel(obs_OBJECT_WORK, AppMain.gm_gmk_stopper_obj_3d_list[0],
            gms_ENEMY_3D_WORK.obj_3d);
        obs_OBJECT_WORK.pos.z = 393216;
        AppMain.ObjAction3dNNMaterialMotionLoad(gms_ENEMY_3D_WORK.obj_3d, 0, null, null, 0,
            (AMS_AMB_HEADER) AppMain.ObjDataGet(849).pData);
    ...
    private static OBS_OBJECT_WORK GmGmkStopperSlotInit(AppMain.GMS_EVE_RECORD_EVENT eve_rec, int pos_x, int pos_y,
        byte type)
    {
        AppMain.GMS_GMK_STOPPER_WORK gms_GMK_STOPPER_WORK =
            (AppMain.GMS_GMK_STOPPER_WORK) AppMain.GMM_ENEMY_CREATE_WORK(eve_rec, pos_x, pos_y,
        ...
        OBS_OBJECT_WORK obs_OBJECT_WORK = (OBS_OBJECT_WORK) gms_GMK_STOPPER_WORK;
        AppMain.GMS_ENEMY_3D_WORK gms_ENEMY_3D_WORK = (AppMain.GMS_ENEMY_3D_WORK) gms_GMK_STOPPER_WORK;
        AppMain.ObjObjectCopyAction3dNNModel(obs_OBJECT_WORK, AppMain.gm_gmk_stopper_obj_3d_list[1],
            gms_ENEMY_3D_WORK.obj_3d);
        obs_OBJECT_WORK.pos.z = 393216;
        AppMain.ObjAction3dNNMaterialMotionLoad(gms_ENEMY_3D_WORK.obj_3d, 0, null, null, 1,
            (AMS_AMB_HEADER) AppMain.ObjDataGet(849).pData);
        gms_ENEMY_3D_WORK.obj_3d.mat_speed = 1f;
        obs_OBJECT_WORK.disp_flag |= 20U;
        obs_OBJECT_WORK.move_flag |= 256U;
    ...
    {
        AppMain.gm_gmk_stopper_obj_3d_list = AppMain.GmGameDBuildRegBuildModel(AppMain.GmGameDatGetGimmickData(847),
            AppMain.GmGameDatGetGimmickData(848), 0U);
    }

    // Token: 0x0600026F RID: 623 RVA: 0x00014044 File Offset: 0x00012244
    private static void GmGmkStopperFlush()
    {
        AMS_AMB_HEADER ams_AMB_HEADER = AppMain.GmGameDatGetGimmickData(847);
