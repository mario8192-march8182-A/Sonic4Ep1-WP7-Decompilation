...
public partial class AppMain
{
    ...
    private static void dmManualProcFadeIn( AppMain.DMS_MANUAL_MAIN_WORK main_work )
    {
        ...
        {
            AppMain.IzFadeExit();
            main_work.proc_update = AppMain.dmManualProcWaitInput;
            main_work.proc_input = AppMain.dmManualInputProcMain;
        }
    }
    ...
    private static void dmManualProcActDraw( AppMain.DMS_MANUAL_MAIN_WORK main_work )
    {
        ...
        {
            AppMain.amDrawMakeTask( AppMain.dmManualTaskDraw, 32768, 0U );
        }
    }
