...
public partial class AppMain
{
    ...
    {
        AppMain.gm_gmk_ss_emerald_obj_3d_list = AppMain.GmGameDBuildRegBuildModel(AppMain.GmGameDatGetGimmickData(910),
            AppMain.GmGameDatGetGimmickData(911), 0U);
        AppMain.gm_gmk_ss_1up_obj_3d_list = AppMain.GmGameDBuildRegBuildModel(AppMain.GmGameDatGetGimmickData(913),
            AppMain.GmGameDatGetGimmickData(914), 0U);
    }
