...
namespace gs.backup
{
	...
	public class SOption
	{
        ...
        public bool GetLoopCamera()
        {
            return this.m_loop_camera == 0 ? false : true;
        }
		...
		public byte[] getData()
		{
			...
			using (MemoryStream memoryStream = new MemoryStream())
			{
				using (BinaryWriter binaryWriter = new BinaryWriter(memoryStream))
				{
					...
					binaryWriter.Write(this.m_loop_camera);
				}
		...
		public void setData(byte[] data)
		{
			using (MemoryStream memoryStream = new MemoryStream(data))
			{
				using (BinaryReader binaryReader = new BinaryReader(memoryStream))
				{
					...
					this.m_loop_camera = binaryReader.ReadUInt32();
				}
			}
		}
        ...
        // Token: 0x06002936 RID: 10550 RVA: 0x00157E7D File Offset: 0x0015607D
		private void SetLoopCamera(bool is_loop_camera)
		{
			this.m_loop_camera = (is_loop_camera ? 1U : 0U);
		}
