...
namespace gs.backup
{
	public class SStageSoloDebug : SStageSolo
	{
		public override void Init()
		{
			...
			for (int i = 0; i < num; i++)
			{
				...
				this.m_record[i].high_score = 10000000U;
				this.m_record[i].fast_time = 60U;
				this.m_record[i].is_high_score_enable = 1U;
				this.m_record[i].is_fast_time_enable = 1U;
				this.m_record[i].is_high_score_uploaded = 1U;
				this.m_record[i].is_fast_time_uploaded = 1U;
			}
			this.m_is_new = 0U;
			this.m_is_high_score_use_supersonic = 1U;
			this.m_is_fast_time_use_supersonic = 0U;
			this.m_is_score_uploaded_once = 1U;
			this.m_is_time_uploaded_once = 1U;
