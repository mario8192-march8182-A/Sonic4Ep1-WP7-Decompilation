...
public class AkUtil
{
    public const int AKD_UTIL_FRAME60_TO_TIME_MAX_FRAME = 215999 / 2;
    
    // Token: 0x06001936 RID: 6454 RVA: 0x000E4240 File Offset: 0x000E2440
    public static void Frame60ToTime(uint frame)
    {
        ushort? num = default(ushort?);
        Frame60ToTime(frame, ref num, ref num, ref num);
    }

    // Token: 0x06001937 RID: 6455 RVA: 0x000E4264 File Offset: 0x000E2464
    public static void Frame60ToTime(uint frame, ref ushort min)
    {
        ushort? num = default(ushort?);
        ushort? num2 = new ushort?(min);
        Frame60ToTime(frame, ref num2, ref num, ref num);
        min = num2.Value;
    }

    // Token: 0x06001938 RID: 6456 RVA: 0x000E429C File Offset: 0x000E249C
    public static void Frame60ToTime(uint frame, ref ushort min, ref ushort sec)
    {
        ushort? num = default(ushort?);
        ushort? num2 = new ushort?(min);
        ushort? num3 = new ushort?(sec);
        Frame60ToTime(frame, ref num2, ref num3, ref num);
        min = num2.Value;
        sec = num3.Value;
    }

    // Token: 0x06001939 RID: 6457 RVA: 0x000E42EC File Offset: 0x000E24EC
    public static void Frame60ToTime(uint frame, ref ushort min, ref ushort sec, ref ushort msec)
    {
        ushort? num = new ushort?(min);
        ushort? num2 = new ushort?(sec);
        ushort? num3 = new ushort?(msec);
        Frame60ToTime(frame, ref num, ref num2, ref num3);
        min = num.Value;
        sec = num2.Value;
        msec = num3.Value;
    }
    ...
    public static void Frame60ToTime(uint frame, ushort? min, ref ushort sec, ushort? msec)
    {
        ushort? num = new ushort?(sec);
        ushort? num2 = default(ushort?);
        Frame60ToTime(frame, ref num2, ref num, ref num2);
        sec = num.Value;
    }
    ...
    {
        ushort? num = default(ushort?);
        Frame60ToTime(frame, ref min, ref num, ref num);
    }
    ...
    {
        ushort? num = default(ushort?);
        Frame60ToTime(frame, ref min, ref sec, ref num);
    }

    // Token: 0x0600193D RID: 6461 RVA: 0x000E43C4 File Offset: 0x000E25C4
    public static void Frame60ToTime(uint frame, ref ushort? min, ref ushort? sec, ref ushort? msec)
    {
        if ((ulong) frame > (ulong) ((long) AKD_UTIL_FRAME60_TO_TIME_MAX_FRAME))
        {
    ...
    public static int NumValueToDigits(int val, int[] digit_list, int digit_num)
    {
        return NumValueToDigits(val, digit_list, digit_num, 10);
    }

    // Token: 0x0600193F RID: 6463 RVA: 0x000E44E4 File Offset: 0x000E26E4
    public static int NumValueToDigits(int val, int[] digit_list, int digit_num, int radix)
    {
        int num = val;
        int num2 = 1;
    ...
    public static int NumValueToDigits(int val, AppMain.ArrayPointer<int> digit_list, int digit_num)
    {
        return NumValueToDigits(val, digit_list, digit_num, 10);
    }

    // Token: 0x06001941 RID: 6465 RVA: 0x000E4524 File Offset: 0x000E2724
    public static int NumValueToDigits(int val, AppMain.ArrayPointer<int> digit_list, int digit_num, int radix)
    {
        int num = val;
        int num2 = 1;
        for (int i = 0; i < digit_num; i++)
