...
public class AkMath
{
    ...
    public static void InvertYZQuaternion(out NNS_QUATERNION dst_quat,
    ...
    public static void InvertXZQuaternion(out NNS_QUATERNION dst_quat,
        ref NNS_QUATERNION src_quat)
    {
        dst_quat = src_quat;
    ...
    public static void InvertXYQuaternion(out NNS_QUATERNION dst_quat,
        ref NNS_QUATERNION src_quat)
    {
        dst_quat = src_quat;
        dst_quat.x = -dst_quat.x;
    ...
    public static byte CountBitPopulation(uint bits)
    {
